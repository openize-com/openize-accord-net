...
namespace FileFormat.Accord.Tests.IO
{
    ...
    public class CsvReaderTest
    {
        ...
        {
            var stream = new StringReader(Resources.csv_simple);
        ...
        {
            var stream = new StringReader(Resources.csv_simple_crlf);
        ...
        {
            var stream = new StringReader(Resources.csv_newlines);
        ...
        {
            var stream = new StringReader(Resources.csv_newlines_crlf);
        ...
        {
            var stream = new StringReader(Resources.csv_quotes_and_newlines);
        ...
        {
            var stream = new StringReader(Resources.csv_escaped_quotes);
        ...
        {
            var stream = new StringReader(Resources.csv_comma_in_quotes);
        ...
        {
            var stream = new StringReader(Resources.csv_empty);
        ...
        {
            var stream = new StringReader(Resources.csv_empty_crlf);
        ...
        {
            var stream = new StringReader(Resources.csv_utf8);
        ...
        {
            var stream = new StringReader(Resources.csv_tabs);
        ...
        {
            var stream = new StringReader(Resources.csv_french);
        ...
        {
            var stream = new StringReader(Resources.csv_pipes);
        ...
        {
            var stream = new StringReader(Resources.csv_double_quotes);
        ...
        {
            var stream = new StringReader(Resources.csv_error_recovery);
