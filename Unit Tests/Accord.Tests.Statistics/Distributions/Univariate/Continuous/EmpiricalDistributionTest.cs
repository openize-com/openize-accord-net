    ...
    public class EmpiricalDistributionTest
    {
        ...
        public void WeightedEmpiricalDistributionConstructorTest()
        {
            ...
            for (double x = 0; x < 6; x += 0.1)
            {
                ...
                expected = distribution.InverseDistributionFunction(Tools.Scale(0, 6, 0, 1, x));
                actual = target.InverseDistributionFunction(Tools.Scale(0, 6, 0, 1, x));
                Assert.AreEqual(expected, actual);
                ...
                expected = distribution.QuantileDensityFunction(Tools.Scale(0, 6, 0, 1, x));
                actual = target.QuantileDensityFunction(Tools.Scale(0, 6, 0, 1, x));
