...
namespace Openize.Accord.Tests.Statistics
{
    ...
    public class CircularTest
    {
        ...
        public void KappaTest1()
        {
            ...
            double actual = Circular.Concentration(this.angles);
        ...
        {
            double mean = Circular.Mean(this.angles);

            double expected = 3.721646;
            double actual = Circular.Concentration(this.angles, mean);
        ...
        public void MeanTest()
        {
            ...
            double actual = Circular.Mean(this.angles);
        ...
        public void VarianceTest()
        {
            ...
            double actual = Circular.Variance(this.angles);
        ...
        public void CircularDeviationTest()
        {
            ...
            */
            ...
            double actual = Circular.AngularDeviation(this.angles);
        ...
        public void StandardDeviationTest()
        {
            ...
            double actual = Circular.StandardDeviation(this.angles);
        ...
        public void SkewnessTest()
        {
            ...
            double actual = Circular.Skewness(this.angles);
        ...
        public void KurtosisTest()
        {
            ...
            double actual = Circular.Kurtosis(this.angles);
        ...
        public void MedianTest()
        {
            ...
            double actual = Circular.Median(this.angles);
        ...
        public void MedianTest_Odd()
        {
            ...
            double actual = Circular.Median(this.angles.RemoveAt(0));
        ...
        {
            DoubleRange range;
            double median = Circular.Quartiles(this.angles, out range);
        ...
        {
            double actual = Circular.StandardError(this.angles, 0.05);
