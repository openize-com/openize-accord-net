namespace Openize.Accord.Tests.Math.AForge
{
    ...
    public class Matrix3x3Test
    {
        ...
        public void CreateRotationYTest(float angle)
        {
            ...
            this.CompareMatrixWithArray(matrix, expectedArray);
        }
        ...
        public void CreateFromYawPitchRollTest(float yaw, float pitch, float roll)
        {
            ...
            this.CompareMatrixWithArray(matrix, rotationMatrix.ToArray());
        }
        ...
        public void InverseTest(float v00, float v01, float v02, float v10, float v11, float v12, float v20, float v21, float v22)
        {
            ...
            Assert.AreEqual(true, this.ApproximateEquals(identity, Matrix3x3.Identity));
        }
        ...
        public void AddMatricesTest()
        {
            ...
            Assert.AreEqual(true, this.ApproximateEquals(result, expectedResult));
        }
