...
namespace FileFormat.Accord.Tests.Math.Matrix
{
    ...
    public partial class MatrixTensor
    {
        ...
        public void squeeze_by_conversion()
        {
            ...
            object actual = ExtensionMethods.To<double[,]>(a);
            Assert.AreEqual(expected, actual);

            actual = ExtensionMethods.To<double[,,]>(a);
            Assert.AreNotEqual(expected, actual);

            actual = ExtensionMethods.To<double[,]>(a.To<double[,,]>());
            Assert.AreEqual(expected, actual);
        }
        ...
        public void convert_with_squeeze()
        {
            ...
            int[,] actual = ExtensionMethods.To<int[,]>(a);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void convert_to_bool_true()
        {
            ...
            bool expected = true;
            bool actual = ExtensionMethods.To<bool>(a);
            Assert.AreEqual(expected, actual);
        }
