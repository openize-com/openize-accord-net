...
namespace FileFormat.Accord.Tests.Math.Optimization
{
    ...
    public class CobylaTest
    {
        ...
        {
            get { return this.propertyTest; }
            set { this.propertyTest = value; }
        }
        ...
        public void cobyla_should_accept_property_values_gh688()
        {
            ...
            NonlinearConstraint[] constraints =
            {
                new NonlinearConstraint(2, x =>  x[0] * x[0] + x[1] * x[1] <= this.PropertyTest)
            };
        ...
        public void ConstructorTest7()
        {
            ...
            Assert.IsTrue(Generator.HasBeenAccessed);
        }
