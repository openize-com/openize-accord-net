...
namespace Openize.Accord.Tests.Imaging
{
    ...
    public class KCurvatureTest
    {
        ...
        {
            Bitmap hand = Image.Clone(Resources.rhand);
            ...
            for (int i = 0; i < peaks.Count; i++)
            {
                ...
                supports.Add(contour[Tools.Mod(j - kcurv.K, contour.Count)]);
            }
...
*/
        ...
        {
            Bitmap hand = Image.Clone(Resources.rhand0);
        ...
        {
            Bitmap hand = Image.Clone(Resources.rhand1);
        ...
        {
            Bitmap hand = Image.Clone(Resources.rhand2);
        ...
        {
            Bitmap hand = Image.Clone(Resources.rhand3);
