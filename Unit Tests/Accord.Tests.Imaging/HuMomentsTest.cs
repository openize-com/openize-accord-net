...
namespace FileFormat.Accord.Tests.Imaging
{
    ...
    using FileFormat.Accord.Imaging.Moments;
    ...
    public class HuMomentsTest
    {
        ...
        {
            var hu0 = new HuMoments(Image.Clone(Resources.hu0));
            var hu1 = new HuMoments(Image.Clone(Resources.hu1));
        ...
        {
            float[,] img1; new ImageToMatrix().Convert(Image.Clone(Resources.tt1), out img1);
            float[,] img2; new ImageToMatrix().Convert(Image.Clone(Resources.tt2), out img2);
            float[,] img3; new ImageToMatrix().Convert(Image.Clone(Resources.tt3), out img3);
            float[,] img4; new ImageToMatrix().Convert(Image.Clone(Resources.tt4), out img4);
