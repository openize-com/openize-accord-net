                ...
                while (j < 12)
                {
                    ...
                    for (int k = i; k < i + 9; ++k)
                    {
                        for (int l = j; l < j + 9; ++l)
                        {
                            ...
                            gauss_s1 = this.Gaussian(xs - sample_x, ys - sample_y, 2.5f * S);
                            rx = (float)this.img.HaarX(sample_y, sample_x, 2 * S);
                            ry = (float)this.img.HaarY(sample_y, sample_x, 2 * S);
                    ...
                    gauss_s2 = this.Gaussian(cx - 2f, cy - 2f, 1.5f);
