...
namespace Openize.Accord.Imaging.Filters
{
    ...
    public class RectanglesMarker : BaseInPlaceFilter
    {
        ...
        {
            get { return this.rectangles.First(); }
            set { this.rectangles = new[] { value }; }
        }
        ...
        protected override void ProcessFilter(UnmanagedImage image)
        {
            ...
            {
                Drawing.Rectangle(image, rectangle, this.markerColor);
                if (this.fillColor != Color.Transparent)
                    Drawing.FillRectangle(image, rectangle, this.fillColor);
            }
        }
    }
}