...
namespace FileFormat.Accord.Imaging.Filters.Transform
{
    using System;
    ...
    using AForge.Imaging.Filters.Transform;
    using Colors;
    ...
    public class RotateNearestNeighbor : BaseRotateFilter
    {
        ...
        protected override void ProcessFilter(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            switch (pixelSize)
            {
                case 1:
                case 3:
                    this.ProcessFilter8bpc(sourceData, destinationData);
                    break;
                case 2:
                case 6:
                    this.ProcessFilter16bpc(sourceData, destinationData);
                    break;
            }
        }
        ...
        private unsafe void ProcessFilter16bpc(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            // fill values
            ushort fillR = (ushort)(this.fillColor.R << 8);
            ushort fillG = (ushort)(this.fillColor.G << 8);
            ushort fillB = (ushort)(this.fillColor.B << 8);
