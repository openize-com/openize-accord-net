...
namespace Openize.Accord.Imaging.Filters
{
    ...
    using AForge.Imaging.Filters._2_Source_filters;
    ...
    public class DifferenceOfGaussians : BaseInPlaceFilter
    {
        ...
        {
            get { return this.subtract; }
            set { this.subtract = value; }
        }
        ...
        protected override void ProcessFilter(UnmanagedImage image)
        {
            ...
            var image1 = this.first.Apply(image);

            // Apply second Gaussian blur
            this.second.ApplyInPlace(image);

            // Subtract the two images
            this.subtract.UnmanagedOverlayImage = image1;
