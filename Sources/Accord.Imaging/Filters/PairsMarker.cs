...
namespace FileFormat.Accord.Imaging.Filters
{
    ...
    public class PairsMarker : BaseInPlaceFilter
    {
        ...
        {
            get { return this.points1; }
            set { this.points1 = value; }
        }
        ...
        {
            get { return this.points2; }
            set { this.points2 = value; }
        }
        ...
        protected override void ProcessFilter(UnmanagedImage image)
        {
            ...
            {
                Drawing.Line(image, this.points1[i], this.points2[i], this.markerColor);
            }
        }
    }
}