            ...
            if (sourceData.PixelFormat == PixelFormat.Format8bppIndexed)
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    for (int x = 0; x < width; x++, src++, dst++)
                    {
                        ...
                        double cut = mean + this.k * Math.Sqrt(variance) - this.c;
            ...
            else
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    for (int x = 0; x < width; x++, src += pixelSize, dst += pixelSize)
                    {
                        ...
                        double cutR = (meanR + this.k * Math.Sqrt(varR) - this.c);
                        double cutG = (meanG + this.k * Math.Sqrt(varG) - this.c);
                        double cutB = (meanB + this.k * Math.Sqrt(varB) - this.c);
