...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Formats
{
    ...
    public sealed class FITSImageInfo : ImageInfo
    {
        ...
        {
            get { return this.originalBitsPerPixl; }
            set { this.originalBitsPerPixl = value; }
        }
        ...
        {
            get { return this.minDataValue; }
            set { this.minDataValue = value; }
        }
        ...
        {
            get { return this.maxDataValue; }
            set { this.maxDataValue = value; }
        }
        ...
        {
            get { return this.telescope; }
            set { this.telescope = value; }
        }
        ...
        {
            get { return this.acquiredObject; }
            set { this.acquiredObject = value; }
        }
        ...
        {
            FITSImageInfo clone = new FITSImageInfo(this.width, this.height, this.bitsPerPixel, this.frameIndex, this.totalFrames);

            clone.originalBitsPerPixl = this.originalBitsPerPixl;
            clone.minDataValue = this.minDataValue;
            clone.maxDataValue = this.maxDataValue;
            clone.telescope = this.telescope;
            clone.acquiredObject = this.acquiredObject;
    ...
    public class FITSCodec : IImageDecoder
    {
        ...
        public int Open(Stream stream)
        {
            ...
            return this.imageInfo.TotalFrames;
        }
        ...
        public Bitmap DecodeFrame(int frameIndex, out ImageInfo imageInfo)
        {
            ...
            this.stream.Seek(this.dataPosition + frameIndex * this.imageInfo.Width * this.imageInfo.Height *
                Math.Abs(this.imageInfo.OriginalBitsPerPixl) / 8, SeekOrigin.Begin);

            // read required frame
            Bitmap image = ReadImageFrame(this.stream, this.imageInfo);
