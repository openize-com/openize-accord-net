...
namespace Openize.Accord.Imaging.AForge.Imaging.Color_Reduction
{
    ...
    public class OrderedColorDithering
    {
        ...
        {
            get { return (byte[,])this.matrix.Clone(); }
            set
            {
                if (value == null)
        ...
        public Bitmap Apply(UnmanagedImage sourceImage)
        {
            ...
            Bitmap destImage = new Bitmap(width, height, (this.colorTable.Length > 16) ?
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        toAdd = this.matrix[(y % rows), (x % cols)];
                        r = ptr[RGB.R] + toAdd;
                        g = ptr[RGB.G] + toAdd;
                        b = ptr[RGB.B] + toAdd;
                        ...
                        this.GetClosestColor(r, g, b, out colorIndex);
