...
namespace FileFormat.Accord.Imaging.AForge.Imaging
{
    ...
    public class ComplexImage : ICloneable
    {
        ...
        {
            get { return this.fourierTransformed; }
        }
        ...
        public object Clone()
        {
            ...
            ComplexImage dstImage = new ComplexImage(this.width, this.height);
            ...
            // clone mode as well
            dstImage.fourierTransformed = this.fourierTransformed;
        ...
        public Bitmap ToBitmap()
        {
            ...
            int offset = dstData.Stride - this.width;
            double scale = (this.fourierTransformed) ? Math.Sqrt(this.width * this.height) : 1;
            ...
            unsafe
            {
                ...
                {
                    for (int x = 0; x < this.width; x++, dst++)
                    {
                        *dst = (byte)System.Math.Max(0, System.Math.Min(255, this.data[y, x].Magnitude * scale * 255));
                    }
                    dst += offset;
                }
            }
        ...
        public void ForwardFourierTransform()
        {
            if (!this.fourierTransformed)
            {
                ...
                FourierTransform.FFT2(this.data, FourierTransform.Direction.Forward);
