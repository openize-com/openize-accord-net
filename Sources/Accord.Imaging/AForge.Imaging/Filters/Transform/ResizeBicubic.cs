...
namespace Openize.Accord.Imaging.AForge.Imaging.Filters.Transform
{
    ...
    public class ResizeBicubic : BaseResizeFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            double xFactor = (double)width / this.newWidth;
            double yFactor = (double)height / this.newHeight;
            ...
            if (destinationData.PixelFormat == PixelFormat.Format8bppIndexed)
            {
                ...
                for (int y = 0; y < this.newHeight; y++)
                {
                    ...
                    for (int x = 0; x < this.newWidth; x++, dst++)
                    {
                        // X coordinates
            ...
            else if (pixelSize == 3)
            {
                ...
                for (int y = 0; y < this.newHeight; y++)
                {
                    ...
                    for (int x = 0; x < this.newWidth; x++, dst += 3)
                    {
                        // X coordinates
                        double ox = (double)x * xFactor - 0.5f;
                        int ox1 = (int)ox;
