...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Transform
{
    ...
    public class TransformFromPolar : BaseTransformationFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            double offsetAngleR = ((this.mapBackwards) ? this.offsetAngle : -this.offsetAngle) / 180 * Math.PI + PiHalf;
            ...
            for (int y = 0; y < newHeight; y++)
            {
                ...
                for (int x = 0; x < newWidth; x++)
                {
                    ...
                    double sx = cx + distance * ((this.mapBackwards) ? -angleCos[x] : angleCos[x]);
