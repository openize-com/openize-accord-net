    ...
    public class SimpleQuadrilateralTransformation : BaseTransformationFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            */
            ...
            double leftFactor = (double)(this.sourceQuadrilateral[3].Y - this.sourceQuadrilateral[0].Y) / dstHeight;
            double rightFactor = (double)(this.sourceQuadrilateral[2].Y - this.sourceQuadrilateral[1].Y) / dstHeight;

            int srcY0 = this.sourceQuadrilateral[0].Y;
            int srcY1 = this.sourceQuadrilateral[1].Y;
