...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Transform
{
    ...
    public class TransformToPolar : BaseTransformationFilter
    {
        ...
        {
            get { return this.circleDepth; }
            set { this.circleDepth = Math.Max( 0, Math.Min( 1, value ) ); }
        }
        ...
        public double OffsetAngle
        {
            ...
            set { this.offsetAngle = Math.Max( -360, Math.Min( 360, value ) ); }
        }
        ...
        {
            get { return this.mapBackwards; }
            set { this.mapBackwards = value; }
        }
        ...
        {
            get { return this.mapFromTop; }
            set { this.mapFromTop = value; }
        }
        ...
        {
            get { return this.useOriginalImageSize; }
            set { this.useOriginalImageSize = value; }
        }
        ...
        {
            return ( this.useOriginalImageSize ) ? new Size( sourceData.Width, sourceData.Height ) : this.newSize;
        }
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage sourceData, UnmanagedImage destinationData )
        {
            ...
            // invert cirlce depth
            double circleDisform = 1 - this.circleDepth;
            ...
            double offsetAngleR = this.offsetAngle / 180 * Math.PI;
            if ( offsetAngleR < 0 )
            {
