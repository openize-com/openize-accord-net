...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Color_Filters
{
    ...
    public class ChannelFiltering : BaseInPlacePartialFilter
    {
        ...
        public IntRange Red
        {
            ...
            {
                this.red = value;
                CalculateMap(this.red, this.fillR, this.redFillOutsideRange, this.mapRed);
            }
        }
        ...
        public IntRange Green
        {
            ...
            {
                this.green = value;
                CalculateMap(this.green, this.fillG, this.greenFillOutsideRange, this.mapGreen);
            }
        }
        ...
        public IntRange Blue
        {
            ...
            {
                this.blue = value;
                CalculateMap(this.blue, this.fillB, this.blueFillOutsideRange, this.mapBlue);
            }
        }
