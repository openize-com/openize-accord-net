...
namespace Openize.Accord.Imaging.AForge.Imaging.Filters.Color_Filters
{
    ...
    public class ReplaceChannel : BaseInPlacePartialFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage image, Rectangle rect)
        {
            ...
            if ((this.channel == RGB.A) && (pixelSize != 4) && (pixelSize != 8))
            ...
            if (this.channelImage != null)
            {
                ...
                chData = this.channelImage.LockBits(
                    ...
                    ImageLockMode.ReadOnly, this.channelImage.PixelFormat);
            ...
            else
            {
                ...
                chFormat = this.unmanagedChannelImage.PixelFormat;
            }
