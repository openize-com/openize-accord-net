...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters._2_Source_filters
{
    ...
    public sealed class Multiply : BaseInPlaceFilter2
    {
        ...
        private void InitFormatTranslations()
        {
            ...
            this._formatTranslations[PixelFormat.Format64bppArgb] = PixelFormat.Format64bppArgb;
        }
