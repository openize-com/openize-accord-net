...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters
{
    ...
    public class FilterIterator : IFilter, IFilterInformation
    {
        ...
        public int Iterations
        {
            ...
            set { this.iterations = Math.Max( 1, Math.Min( 255, value ) ); }
        }
        ...
        public Bitmap Apply( Bitmap image )
        {
            ...
            // apply the filter
            Bitmap dstImage = this.Apply( imageData );
        ...
        {
            // initial iteration
            Bitmap dstImg = this.baseFilter.Apply( imageData );
            Bitmap tmpImg;
            ...
            {
                tmpImg = dstImg;
                dstImg = this.baseFilter.Apply( tmpImg );
                tmpImg.Dispose( );
            }
        ...
        {
            // initial iteration
            UnmanagedImage dstImg = this.baseFilter.Apply( image );
        ...
        public void Apply( UnmanagedImage sourceImage, UnmanagedImage destinationImage )
        {
            ...
            {
                // initial iteration
                UnmanagedImage dstImg = this.baseFilter.Apply( sourceImage );
                UnmanagedImage tmpImg;
                ...
                this.baseFilter.Apply( dstImg, destinationImage );
            }
        }
    }
}
