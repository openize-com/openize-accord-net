...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.HSL_Filters
{
    ...
    public class SaturationCorrection : BaseInPlacePartialFilter
    {
        ...
        public float AdjustValue
        {
            ...
            set { this.adjustValue = Math.Max(-1.0f, Math.Min(1.0f, value)); }
        }
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage image, Rectangle rect)
        {
            ...
            float desaturationChangeFactor = 1.0f + this.adjustValue;
            ...
            for (int y = startY; y < stopY; y++)
            {
                ...
                for (int x = startX; x < stopX; x++, ptr += pixelSize)
                {
                    ...
                    {
                        hsl.Saturation += (1.0f - hsl.Saturation) * this.adjustValue * hsl.Saturation;
                    }
