...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Morphology
{
    ...
    public class Opening : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        {
            Bitmap tempImage = this.errosion.Apply(image);
            Bitmap destImage = this.dilation.Apply(tempImage);
        ...
        {
            Bitmap tempImage = this.errosion.Apply(imageData);
            Bitmap destImage = this.dilation.Apply(tempImage);
        ...
        {
            UnmanagedImage destImage = this.errosion.Apply(image);
            this.dilation.ApplyInPlace(destImage);
        ...
        public void Apply(UnmanagedImage sourceImage, UnmanagedImage destinationImage)
        {
            ...
            this.dilation.ApplyInPlace(destinationImage);
        }
