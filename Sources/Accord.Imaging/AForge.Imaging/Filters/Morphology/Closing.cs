...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Morphology
{
    ...
    public class Closing : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        {
            get { return this.errosion.FormatTranslations; }
        }
        ...
        {
            Bitmap tempImage = this.dilation.Apply(image);
            Bitmap destImage = this.errosion.Apply(tempImage);
        ...
        {
            Bitmap tempImage = this.dilation.Apply(imageData);
            Bitmap destImage = this.errosion.Apply(tempImage);
        ...
        {
            UnmanagedImage destImage = this.dilation.Apply(image);
            this.errosion.ApplyInPlace(destImage);
        ...
        {
            this.dilation.Apply(sourceImage, destinationImage);
        ...
        {
            this.dilation.ApplyInPlace(image);
        ...
        {
            this.dilation.ApplyInPlace(imageData);
        ...
        {
            this.dilation.ApplyInPlace(image, rect);
        ...
        {
            this.dilation.ApplyInPlace(imageData, rect);
