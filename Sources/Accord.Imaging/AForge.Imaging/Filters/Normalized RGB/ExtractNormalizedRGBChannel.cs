...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Normalized_RGB
{
    using System;
            ...
            if (pixelSize <= 4)
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    for (int x = 0; x < width; x++, src += pixelSize, dst++)
                    {
                        ...
                        *dst = (sum != 0) ? (byte)(255 * src[this.channel] / sum) : (byte)0;
                    }
                    src += srcOffset;
                    dst += dstOffset;
                }
            ...
            else
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    for (int x = 0; x < width; x++, src += pixelSize, dst++)
                    {
                        ...
                        *dst = (sum != 0) ? (ushort)(65535 * src[this.channel] / sum) : (ushort)0;
                    }
                }
            }
        }
