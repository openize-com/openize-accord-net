...
namespace Openize.Accord.Imaging.AForge.Imaging.Filters.Convolution
{
    ...
    public class FastBoxBlur : BaseInPlacePartialFilter
    {
        ...
        {
            get { return this._formatTranslations; }
        }
        ...
        {
            get { return this._horizontalKernelSize; }
            set
            {
                this._horizontalKernelSize = System.Math.Max((byte)3, System.Math.Min((byte)99, value));
            }
        }
        ...
        {
            get { return this._verticalKernelSize; }
            set
            {
                this._verticalKernelSize = System.Math.Max((byte)3, System.Math.Min((byte)99, value));
            }
        }
        ...
        public FastBoxBlur()
        {
            ...
            this._formatTranslations[PixelFormat.Format8bppIndexed] = PixelFormat.Format8bppIndexed;
            this._formatTranslations[PixelFormat.Format24bppRgb] = PixelFormat.Format24bppRgb;
            this._formatTranslations[PixelFormat.Format32bppRgb] = PixelFormat.Format32bppRgb;
            this._formatTranslations[PixelFormat.Format32bppArgb] = PixelFormat.Format32bppArgb;
            this._formatTranslations[PixelFormat.Format16bppGrayScale] = PixelFormat.Format16bppGrayScale;
            this._formatTranslations[PixelFormat.Format48bppRgb] = PixelFormat.Format48bppRgb;
        }
        ...
        {
            HorizontalBoxBlur(ref image, rect, KernelSizeInRange(this._horizontalKernelSize));

            VerticalBoxBlur(ref image, rect, KernelSizeInRange(this._verticalKernelSize));
        }
