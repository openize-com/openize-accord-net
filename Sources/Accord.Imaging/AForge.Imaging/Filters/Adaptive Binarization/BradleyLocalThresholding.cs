...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Adaptive_Binarization
{
    using System;
    ...
    public class BradleyLocalThresholding : BaseInPlaceFilter
    {
        ...
        public int WindowSize
        {
            ...
            set { this.windowSize = Math.Max( 3, value | 1 ); }
        }
        ...
        {
            get { return this.pixelBrightnessDifferenceLimit; }
            set { this.pixelBrightnessDifferenceLimit = Math.Max( 0.0f, Math.Min( 1.0f, value ) ); }
        }
