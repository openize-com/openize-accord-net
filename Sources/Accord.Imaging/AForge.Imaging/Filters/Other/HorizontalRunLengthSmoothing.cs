...
namespace Openize.Accord.Imaging.AForge.Imaging.Filters.Other
{
    ...
    public class HorizontalRunLengthSmoothing : BaseInPlacePartialFilter
    {
        ...
        {
            get { return this.maxGapSize; }
            set { this.maxGapSize = Math.Max( 1, Math.Min( 1000, value ) ); }
        }
        ...
        {
            get { return this.processGapsWithImageBorders; }
            set { this.processGapsWithImageBorders = value; }
        }
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image, Rectangle rect )
        {
            ...
            for ( int y = startY; y < stopY; y++ )
            {
                ...
                while ( ptr < lineEndPtr )
                {
                    ...
                    if ( ptr - gapStart <= this.maxGapSize )
                    {
                        if ( ( this.processGapsWithImageBorders ) ||
