...
namespace FileFormat.Accord.Imaging.AForge.Imaging.Filters.Other
{
    ...
    public class ImageWarp : BaseFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage sourceData, UnmanagedImage destinationData)
        {
            ...
            int widthToProcess = Math.Min(width, this.warpMap.GetLength(1));
            int heightToProcess = Math.Min(height, this.warpMap.GetLength(0));
            ...
            for (int y = 0; y < heightToProcess; y++)
            {
                ...
                for (int x = 0; x < widthToProcess; x++)
                {
                    ...
                    ox = x + this.warpMap[y, x].X;
                    oy = y + this.warpMap[y, x].Y;
