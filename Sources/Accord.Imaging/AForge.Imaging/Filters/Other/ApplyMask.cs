    ...
    public class ApplyMask : BaseInPlacePartialFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage image, Rectangle rect)
        {
            if (this.mask != null)
            {
                ...
                {
                    ProcessImage(image, rect, maskPtr, this.mask.GetLength(1));
                }
            }
            else if (this.unmanagedMaskImage != null)
            {
                ...
                ProcessImage(image, rect, (byte*)this.unmanagedMaskImage.ImageData.ToPointer(),
            ...
            else if (this.maskImage != null)
            {
                ...
                BitmapData maskData = this.maskImage.LockBits(new Rectangle(0, 0, image.Width, image.Height),
