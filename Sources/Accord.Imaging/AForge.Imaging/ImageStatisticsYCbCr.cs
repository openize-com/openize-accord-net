...
namespace FileFormat.Accord.Imaging.AForge.Imaging
{
    ...
    public class ImageStatisticsYCbCr
    {
        ...
        {
            get { return this.yHistogramWithoutBlack; }
        }
        ...
        {
            get { return this.cbHistogramWithoutBlack; }
        }
        ...
        {
            get { return this.crHistogramWithoutBlack; }
        }
        ...
        private unsafe void ProcessImage(UnmanagedImage image, byte* mask, int maskLineSize)
        {
            ...
            // create histograms
            this.yHistogram = new ContinuousHistogram(yhisto, new Range(0.0f, 1.0f));
            this.cbHistogram = new ContinuousHistogram(cbhisto, new Range(-0.5f, 0.5f));
            this.crHistogram = new ContinuousHistogram(crhisto, new Range(-0.5f, 0.5f));

            this.yHistogramWithoutBlack = new ContinuousHistogram(yhistoWB, new Range(0.0f, 1.0f));
            this.cbHistogramWithoutBlack = new ContinuousHistogram(cbhistoWB, new Range(-0.5f, 0.5f));
            this.crHistogramWithoutBlack = new ContinuousHistogram(crhistoWB, new Range(-0.5f, 0.5f));
        }
