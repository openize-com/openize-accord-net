...
namespace Openize.Accord.Imaging.AForge.Imaging
{
    ...
    public class HoughCircle : IComparable
    {
        ...
        {
            return (-this.Intensity.CompareTo(((HoughCircle)obj).Intensity));
        }
    }
    ...
    public class HoughCircleTransformation
    {
        ...
        public void ProcessImage(UnmanagedImage image)
        {
            ...
            int srcOffset = image.Stride - this.width;
        ...
        {
            // lines count
            int n = Math.Min(count, this.circles.Count);
        ...
        {
            int x = 0;
            int y = this.radiusToDetect;
            int p = (5 - this.radiusToDetect * 4) / 4;
