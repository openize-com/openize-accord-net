...
namespace Openize.Accord.Imaging.AForge.Imaging
{
    ...
    public class SusanCornersDetector : BaseCornersDetector
    {
        ...
        {
            get { return this.geometricalThreshold; }
            set { this.geometricalThreshold = value; }
        }
                ...
                for (int y = 3, maxY = height - 3; y < maxY; y++)
                {
                    ...
                    for (int x = 3, maxX = width - 3; x < maxX; x++, src++)
                    {
                        ...
                        for (int i = -3; i <= 3; i++)
                        {
                            ...
                            {
                                // differenceThreshold
                                if (System.Math.Abs(nucleusValue - ptr[j]) <= this.differenceThreshold)
                                {
                                    usan++;
                        ...
                        // check usan size
                        if (usan < this.geometricalThreshold)
                        {
                            cx /= usan;
                            cy /= usan;
                            ...
                            if ((x != cx) || (y != cy))
                            {
                                ...
                                usan = (this.geometricalThreshold - usan);
                            }
                            else
                            {
                                usan = 0;
        ...
        {
            return new SusanCornersDetector(this.differenceThreshold, this.geometricalThreshold)
            {
