...
#pragma warning restore CS0612 // Type or member is obsolete
    {
        ...
        {
            var t = (IEnumerable<IFeatureDescriptor<double[]>>)this.Transform(image);
        ...
        {
            var t = (IEnumerable<IFeatureDescriptor<double[]>>)this.Transform(new UnmanagedImage(imageData));
            return new List<double[]>(t.Select(x => x.Descriptor));
        }
        ...
        {
            return this.Transform(new UnmanagedImage(imageData));
        }
        ...
        {
            return input.LockBits(ImageLockMode.ReadOnly, (bmp) => this.Transform(bmp));
        }
        ...
        public IEnumerable<TFeature>[] Transform(Bitmap[] input)
        {
            return this.Transform(input, new IList<TFeature>[input.Length]);
        }
        ...
        public IEnumerable<TFeature> Transform(UnmanagedImage input)
        {
            ...
            return this.InnerTransform(input);
        }
        ...
        public object Clone()
        {
            return this.Clone(this.SupportedFormats);
        }
