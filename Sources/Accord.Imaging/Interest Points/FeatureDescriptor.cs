...
namespace Openize.Accord.Imaging.Interest_Points
{
    ...
    public class FeatureDescriptor : IFeatureDescriptor<double[]>
    {
        ...
        ///   to <see cref="FeatureDescriptor{T}"/>.
        /// </summary>
        /// 
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is FeatureDescriptor))
                return false;
            return this.descriptor == ((FeatureDescriptor)obj).descriptor;
        }
    ...
    public struct FeatureDescriptor<T> : IFeatureDescriptor<T>
    {
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is FeatureDescriptor))
                return false;
            return this.descriptor.Equals(((FeatureDescriptor<T>)obj).descriptor);
        }
