...
namespace FileFormat.Accord.Imaging
{
    ...
    public unsafe class IntegralImage2 : IDisposable
    {
        ...
        {
            size_t a = this.nWidth * (y) + (x);
            size_t b = this.nWidth * (y + height) + (x + width);
            size_t c = this.nWidth * (y + height) + (x);
            size_t d = this.nWidth * (y) + (x + width);
        ...
        {
            size_t a = this.tWidth * (y + width) + (x + width + 1);
            size_t b = this.tWidth * (y + height) + (x - height + 1);
            size_t c = this.tWidth * (y) + (x + 1);
            size_t d = this.tWidth * (y + width + height) + (x + width - height + 1);
