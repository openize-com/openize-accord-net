...
namespace FileFormat.Accord.Imaging
{
    ...
    public class ObjectiveFidelity
    {
        ...
        {
            get { return this.signalNoiseRatio; }
        }
        ...
        {
            get { return this.peakSignalNoiseRatio; }
        }
        ...
        {
            get { return this.derivativeSignalNoiseRatio; }
        }
        ...
        public void Compute(Bitmap a, Bitmap b)
        {
            ...
            this.Compute(new UnmanagedImage(dataOriginal), new UnmanagedImage(dataReconstructed));
        ...
        {
            this.Compute(new UnmanagedImage(a), new UnmanagedImage(b));
        }
        ...
        public void Compute(UnmanagedImage a, UnmanagedImage b)
        {
            ...
            // root mean square
            this.mse = System.Math.Sqrt(this.meanError);
            ...
            if (sumOfSquares != 0)
            {
                ...
                this.peakSignalNoiseRatio = 10 * Math.Log10((this.level * this.level) / this.meanError);
            }
            else
            {
