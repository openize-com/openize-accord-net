...
namespace Openize.Accord.Imaging
{
    ...
    public struct PointH
    {
        ...
        {
            float x = matrix[0, 0] * this.px + matrix[0, 1] * this.py + matrix[0, 2] * this.pw;
            float y = matrix[1, 0] * this.px + matrix[1, 1] * this.py + matrix[1, 2] * this.pw;
            float w = matrix[2, 0] * this.px + matrix[2, 1] * this.py + matrix[2, 2] * this.pw;
        ...
        {
            this.px = this.px / this.pw;
            this.py = this.py / this.pw;
            this.pw = 1;
        }
        ...
        public bool IsEmpty
        {
            get { return this.px == 0 && this.py == 0; }
        }
        ...
        {
            return new double[] { this.px, this.py, this.pw };
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                PointH p = (PointH)obj;
                if (this.px / this.pw == p.px / p.pw &&
                    this.py / this.pw == p.py / p.pw)
                    return true;
            }
        ...
        {
            return this.px.GetHashCode() ^ this.py.GetHashCode() ^ this.pw.GetHashCode();
        }
