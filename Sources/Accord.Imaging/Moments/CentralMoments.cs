...
namespace FileFormat.Accord.Imaging.Moments
{
    using System;
    ...
    public class CentralMoments : MomentsBase, IMoments
    {
        ...
        public void Compute(RawMoments moments)
        {
            ...
            this.Mu00 = moments.M00;

            this.Mu01 = this.Mu10 = 0;
            this.Mu11 = moments.M11 - moments.M01 * x;

            this.Mu20 = moments.M20 - moments.M10 * x;
            this.Mu02 = moments.M02 - moments.M01 * y;

            this.Mu21 = moments.M21 - 2 * x * moments.M11 - y * moments.M20 + 2 * x * x * moments.M01;
            this.Mu12 = moments.M12 - 2 * y * moments.M11 - x * moments.M02 + 2 * y * y * moments.M10;

            this.Mu30 = moments.M30 - 3 * x * moments.M20 + 2 * x * x * moments.M10;
            this.Mu03 = moments.M03 - 3 * y * moments.M02 + 2 * y * y * moments.M01;

            this.invM00 = moments.InvM00;
        }
        ...
        {
            this.Compute(new RawMoments(image, area, this.Order));
        }
        ...
        public SizeF GetSize()
        {
            ...
            //
            double a = this.Mu20 * this.invM00; //                | a    b |
            double b = this.Mu11 * this.invM00; //  Cov[I(x,y)] = |        |
            double c = this.Mu02 * this.invM00; //                | b    c |
