...
namespace FileFormat.Accord.Imaging.Moments
{
    ...
    public class HuMoments : MomentsBase, IMoments
    {
        ...
        public void Compute(CentralMoments moments)
        {
            ...
            //   (η20 − η02)²              + 4    η11²
            this.I2 = (n20 - n02) * (n20 - n02) + 4 * (n11 * n11);


            //   (η30 − 3   η12)²
            this.I3 = (n30 - 3 * n12) * (n30 - 3 * n12)
            ...
            //   (η30 + η12)²              + (η21 + η03)²
            this.I4 = (n30 + n12) * (n30 + n12) + (n21 + n03) * (n21 + n03);


            //   (η30 − 3   η12)   (η30 + η12)   [(η30 + η12)²               −3   (η21 + η03)²             ]
            this.I5 = (n30 - 3 * n12) * (n30 + n12) * ((n30 + n12) * (n30 + n12) - 3 * (n21 + n03) * (n21 + n03))
            ...
            this.I6 = (n20 - n02) * ((n30 + n12) * (n30 + n12) - (n21 + n03) * (n21 + n03))
            ...
            this.I7 = (3 * n21 - n03) * (n30 + n12) * (n30 + n12) * ((n30 + n12) * (n30 + n12) - 3 * (n21 + n03) * (n21 + n03))
        ...
        {
            RawMoments raw = new RawMoments(image, area, this.Order);
