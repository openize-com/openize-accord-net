...
namespace FileFormat.Accord.Imaging.Converters
{
        ...
        IConverter<UnmanagedImage, Complex[][]>
    {
        ...
        public void Convert(Bitmap input, out double[,] output)
        {
            ...
            this.Convert(new UnmanagedImage(bitmapData), out output);
        ...
        public void Convert(UnmanagedImage input, out double[,] output)
        {
            ...
            unsafe
            {
                ...
                {
                    double* dst = ptrData;
                    byte* src = (byte*)input.ImageData.ToPointer() + this.Channel;

                    for (int y = 0; y < height; y++)
                    {
                        for (int x = 0; x < width; x++, src += pixelSize, dst++)
                            *dst = Vector.Scale(*src, (byte)0, (byte)255, this.Min, this.Max);
                        src += offset;
                    }
                }
            }
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    for (int x = 0; x < width; x++, src += pixelSize)
                        output[y][x] = Vector.Scale(*src, (byte)0, (byte)255, this.Min, this.Max);
                    src += offset;
                }
            }
        }
                ...
                for (int y = 0; y < height; y++)
                {
                    for (int x = 0; x < width; x++)
                    {
                        for (int d = 0; d < pixelSize; d++, src++)
                            output[y][x][d] = Vector.Scale(*src, (byte)0, (byte)255, this.Min, this.Max);
                    }
                    src += offset;
                }
            }
        ...
        public void Convert(UnmanagedImage input, out float[,,] output)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        for (int d = 0; d < pixelSize; d++, src++)
                            output[y, x, d] = (float)Vector.Scale(*src, (float)0, (float)255, this.Min, this.Max);
                    }
                    src += offset;
                }
            }
        ...
        public void Convert(UnmanagedImage input, out float[][][] output)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        for (int d = 0; d < pixelSize; d++, src++)
                            output[y][x][d] = (float)Vector.Scale(*src, (byte)0, (byte)255, this.Min, this.Max);
                    }
                    src += offset;
                }
            }
        ...
        public void Convert(UnmanagedImage input, out byte[,,] output)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        for (int d = 0; d < pixelSize; d++, src++)
                            output[y, x, d] = (byte)Vector.Scale(*src, (byte)0, (byte)255, this.Min, this.Max);
                    }
                    src += offset;
                }
            }
        ...
        public void Convert(UnmanagedImage input, out double[,,] output)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < height; y++)
                {
                    ...
                    {
                        for (int d = 0; d < pixelSize; d++, src++)
                            output[y, x, d] = Vector.Scale(*src, (double)0, (double)255, this.Min, this.Max);
                    }
                    src += offset;
                }
            }
