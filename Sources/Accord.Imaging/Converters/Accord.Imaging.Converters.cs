...
namespace Openize.Accord.Imaging.Converters
{
    ...
    ///   series of individual pixel colors into <see cref="Bitmap"/>s, and back from those
    ///   <see cref="Bitmap"/>s into any of the aforementioned representations. Support for
