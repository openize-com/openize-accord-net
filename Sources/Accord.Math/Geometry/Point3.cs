...
namespace Openize.Accord.Math.Geometry
{
    ...
    public struct Point3
    {
        ...
        public float Z
        {
            get { return this.coordinates.Z; }
            set { this.coordinates.Z = value; }
        }


        /// <summary>
        ///   Performs an implicit conversion from
        ///   <see cref="Point3"/> to <see cref="Vector3"/>.
        /// </summary>
        /// 
        ...
        /// <summary>
        ///   Performs an implicit conversion from
        ///   <see cref="Point3"/> to <see cref="Point3"/>.
        /// </summary>
        /// 
        ...
        /// <summary>
        ///   Performs a conversion from <see cref="Vector3"/>
        ///   to <see cref="Point3"/>.
        /// </summary>
        /// 
        ...
        {
            return (Math.Abs(this.coordinates.X - other.coordinates.X) < tolerance)
                && (Math.Abs(this.coordinates.Y - other.coordinates.Y) < tolerance)
                && (Math.Abs(this.coordinates.Z - other.coordinates.Z) < tolerance);
        }
