...
namespace FileFormat.Accord.Math.Geometry
{
    ...
    public class Circle
    {
        ...
        {
            get { return 2 * this.Radius * Math.PI; }
        }
        ...
        {
            this.Origin = new Point((float)x, (float)y);
            this.Radius = radius;
        }
        ...
        public Circle(Point p1, Point p2, Point p3)
        {
            ...
            this.Origin = new Point((float)x, (float)y);
            this.Radius = this.Origin.DistanceTo(p1);
        }
        ...
        {
            return Math.Abs(this.Origin.DistanceTo(point) - this.Radius);
        }
    }
}
