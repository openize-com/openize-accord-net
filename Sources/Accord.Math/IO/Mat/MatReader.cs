...
namespace FileFormat.Accord.Math.IO.Mat
{
    ...
    public class MatReader : IDisposable
    {
        ...
        {
            get { return this.contents.Keys.OrderBy(x => x).ToArray(); }
        }
        ...
        /// </summary>
        /// 
        public bool Transpose { get { return this.autoTranspose; } }
        ...
        {
            get { return this.contents[key.ToString()]; }
        }
        ...
        {
            this.init(new BinaryReader(new FileStream(fileName, FileMode.Open, FileAccess.Read)), autoTranspose, lazy);
        }
        ...
        {
            this.init(new BinaryReader(input), autoTranspose, lazy);
        }
        ...
        {
            this.init(new BinaryReader(new MemoryStream(input)), autoTranspose, lazy);
        }
        ...
        {
            this.init(reader, autoTranspose, lazy);
        }
        ...
        private void init(BinaryReader reader, bool autoTranspose, bool lazy)
        {
            ...
            this.Description = new String(title, 0, terminator).Trim();
            this.Version = version;
            this.BigEndian = endian[0] == 'M';
        ...
        {
            return (T)this.Fields[key].Value;
        }
