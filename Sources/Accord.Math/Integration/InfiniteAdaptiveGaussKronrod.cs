...
namespace Openize.Accord.Math.Integration
{
        ...
        INumericalIntegration<InfiniteAdaptiveGaussKronrodStatus>
    {
        ...
        /// </summary>
        /// 
        public int Subintervals { get { return this.iwork.Length; } }
        ...
        {
            get { return this.abstol; }
            set { this.abstol = value; }
        }
        ...
        /// </summary>
        /// 
        public double Area { get { return this.result; } }
        ...
        /// </summary>
        /// 
        public double Error { get { return this.error; } }
        ...
        /// </summary>
        /// 
        public int FunctionEvaluations { get { return this.evaluations; } }
        ...
        {
            this.init(subintervals, null, Double.MinValue, Double.MaxValue);
        }
        ...
        public InfiniteAdaptiveGaussKronrod(int subintervals, Func<double, double> function)
        {
            ...
            this.init(subintervals, function, Double.MinValue, Double.MaxValue);
        }
            ...
            Func<double, double> function, double a, double b)
        {
            ...
            this.init(subintervals, function, a, b);
        }
        ...
        private void init(int subintervals, Func<double, double> function, double a, double b)
        {
            ...
            this.Range = new DoubleRange(a, b);

            this.ToleranceAbsolute = 0;
            this.ToleranceRelative = 1e-3;

            this.work = new double[subintervals * 4 + 100];
            this.iwork = new int[subintervals + 100];

            this.limit = subintervals;
            this.lenw = subintervals * 4;
        }
        ...
        public bool Compute()
        {
            this.Status = InfiniteAdaptiveGaussKronrodStatus.Success;
            ...
            {
                NonAdaptiveGaussKronrod.qng_(this.Function, a, b, this.ToleranceAbsolute, this.ToleranceRelative,
                        out this.result, out this.error, out this.evaluations, out errorCode);
            }
            ...
            else
            {
                ...
                qagi_(this.Function, bound, inf, this.ToleranceAbsolute, this.ToleranceRelative,
                    out this.result, out this.error, out this.evaluations, out errorCode,
                    this.limit, this.lenw, out last, this.iwork, this.work);
            }
            ...
            this.Status = (InfiniteAdaptiveGaussKronrodStatus)errorCode;

            return this.Status == InfiniteAdaptiveGaussKronrodStatus.Success;
        }
            ...
            ref double abserr, double* res3la, ref int nres)
        {
            ...
            for (i__ = 1; i__ <= newelm; ++i__)
            {
                ...
                Debug.Assert(k3 > 0 && k3 < 52);
                Debug.Assert(k2 > 0 && k2 < 52);
            ...
            for (i__ = 1; i__ <= i__1; ++i__)
            {
                ...
                Debug.Assert(ib > 0 && ib < 52);
                Debug.Assert(ib2 > 0 && ib2 < 52);
            ...
            for (i__ = 1; i__ <= n; ++i__)
            {
                Debug.Assert(i__ > 0 && i__ < 52);
                Debug.Assert(indx > 0 && indx < 52);
        ...
        public object Clone()
        {
            ...
            clone.evaluations = this.evaluations;
            clone.iwork = (int[])this.iwork.Clone();
            clone.work = (double[])this.work.Clone();
            clone.error = this.error;
            clone.result = this.result;
            clone.ToleranceAbsolute = this.ToleranceAbsolute;
            clone.ToleranceRelative = this.ToleranceRelative;
