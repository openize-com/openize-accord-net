...
namespace FileFormat.Accord.Math.Optimization
{
    ...
    public class NonlinearObjectiveFunction : IObjectiveFunction
    {
        ...
        {
            get { return this.readOnlyIndices; }
        }
        ...
        /// </summary>
        /// 
        protected Dictionary<string, int> InnerVariables { get { return this.variables; } }

        /// <summary>
        ///   Gets the index of each input variable in the function.
        /// </summary>
        /// 
        protected Dictionary<int, string> InnerIndices { get { return this.indices; } }
        ...
        protected NonlinearObjectiveFunction()
        {
            ...
            this.readOnlyVariables = new ReadOnlyDictionary<string, int>(this.variables);
            this.readOnlyIndices = new ReadOnlyDictionary<int, string>(this.indices);
        }
            ...
            : this()
        {
            ...
            {
                string name = "x" + i;
                this.variables.Add(name, i);
                this.indices.Add(i, name);
            }
        }
            ...
            : this()
        {
            ...
            {
                this.variables.Add(variable, index);
                this.indices.Add(index, variable);
                index++;
            }

            this.NumberOfVariables = index;

            // Generate lambda functions
            var func = ExpressionParser.Replace(function, this.variables);
            var grad = ExpressionParser.Replace(gradient, this.variables);
