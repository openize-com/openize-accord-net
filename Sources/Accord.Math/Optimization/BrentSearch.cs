    ...
    public sealed class BrentSearch : IOptimizationMethod<double, double>
    {
        ...
        public bool FindRoot()
        {
            BrentSearchResult result = FindRootInternal(
                this.Function, this.LowerBound, this.UpperBound, this.Tolerance, this.MaxIterations);

            this.Solution = result.Solution;
            this.Value = result.Value;
            this.Status = result.Status;

            return this.Status == BrentSearchStatus.Success;
        }
        ...
        {
            BrentSearchResult result = FindRootInternal(
                x => this.Function(x) - value, this.LowerBound, this.UpperBound, this.Tolerance, this.MaxIterations);
        ...
        {
            BrentSearchResult result = MinimizeInternal(
                x => -this.Function(x), this.LowerBound, this.UpperBound, this.Tolerance, this.MaxIterations);
