    ...
    public struct Vector4
    {
        ...
        public override string ToString( )
        {
            return string.Format( System.Globalization.CultureInfo.InvariantCulture,
                "{0}, {1}, {2}, {3}", this.X, this.Y, this.Z, this.W );
        }
        ...
        {
            float norm = (float) System.Math.Sqrt( this.X * this.X + this.Y * this.Y + this.Z * this.Z + this.W * this.W );
        ...
        {
            return new Vector4(
                ( this.X == 0 ) ? 0 : 1.0f / this.X,
                ( this.Y == 0 ) ? 0 : 1.0f / this.Y,
                ( this.Z == 0 ) ? 0 : 1.0f / this.Z,
                ( this.W == 0 ) ? 0 : 1.0f / this.W );
        }
        ...
        public Vector4 Abs( )
        {
            return new Vector4( System.Math.Abs( this.X ), System.Math.Abs( this.Y ), System.Math.Abs( this.Z ), System.Math.Abs( this.W ) );
        }
