...
namespace FileFormat.Accord.Math.AForge.Math.Geometry
{
    ...
    /// <img src="..\images\math\flat_angles_optimizer.png" width="268" height="238" />
    /// </para>
    /// </remarks>
    /// 
    public class FlatAnglesOptimizer : IShapeOptimizer
    {
        ...
        {
            get { return this.maxAngleToKeep; }
            set { this.maxAngleToKeep = Math.Min( 180, Math.Max( 140, value ) ); }
        }
