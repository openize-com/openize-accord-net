...
namespace FileFormat.Accord.Math.AForge.Math.Geometry
{
    ...
    public class Posit
    {
        ...
        public Posit( Vector3[] model, float focalLength )
        {
            ...
            this.modelPseudoInverse = this.modelVectors.PseudoInverse( );
        }
        ...
        public void EstimatePose( Point[] points, out Matrix3x3 rotation, out Vector3 translation )
        {
            ...
            for ( ; count < 100; count++ )
            {
                ...
                iVector = this.modelPseudoInverse * imageXs;
                jVector = this.modelPseudoInverse * imageYs;
                ...
                Z0 = this.focalLength / scale;

                // calculate new epsilon values
                Vector3 oldEps = eps;
                eps = ( this.modelVectors * kVector ) / Z0 + 1;
            ...
            Vector3 temp = rotation * this.modelPoints[0];
