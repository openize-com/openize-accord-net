...
namespace FileFormat.Accord.Math.AForge.Math
{
    ...
    public struct Vector3
    {
        ...
        public float Norm
        {
            get { return (float) System.Math.Sqrt( this.X * this.X + this.Y * this.Y + this.Z * this.Z ); }
        }
        ...
        {
            float norm = (float) System.Math.Sqrt( this.X * this.X + this.Y * this.Y + this.Z * this.Z );
        ...
        public Vector3 Abs( )
        {
            return new Vector3( System.Math.Abs( this.X ), System.Math.Abs( this.Y ), System.Math.Abs( this.Z ) );
        }
