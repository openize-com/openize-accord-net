...
namespace Openize.Accord.Math.AForge.Math
{
    ...
    public class Gaussian
    {
        ...
        public double Sigma
        {
            ...
            set
            {
                this.sigma = Math.Max(0.00000001, value);
        ...
        {
            return Normal.Gaussian(this.sqrSigma, x);
        }
        ...
        {
            return Normal.Gaussian2D(this.sqrSigma, x, y);
        }
        ...
        {
            return Normal.Kernel(this.sqrSigma, size);
        }
        ...
        {
            return Normal.Kernel2D(this.sqrSigma, size);
        }
    }
}
