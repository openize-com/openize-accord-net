...
namespace FileFormat.Accord.Math.AForge.Math
{
    ...
    public struct Matrix3x3
    {
        ...
        public float Determinant
        {
            ...
            {
                return
                    this.V00 * this.V11 * this.V22 + this.V01 * this.V12 * this.V20 + this.V02 * this.V10 * this.V21 -
                    this.V00 * this.V12 * this.V21 - this.V01 * this.V10 * this.V22 - this.V02 * this.V11 * this.V20;
            }
        }
        ...
        public float[] ToArray( )
        {
            return new float[]
            {
                this.V00, this.V01, this.V02, this.V10, this.V11, this.V12, this.V20, this.V21, this.V22
            };
        }
        ...
        {
            yaw   = (float) Math.Atan2( this.V02, this.V22 );
            pitch = (float) Math.Asin( -this.V12 );
            roll  = (float) Math.Atan2( this.V10, this.V11 );
        }
        ...
        public Vector3 GetRow( int index )
        {
            ...
            return ( index == 0 ) ? new Vector3( this.V00, this.V01, this.V02 ) :
                   ( index == 1 ) ? new Vector3( this.V10, this.V11, this.V12 ) : new Vector3( this.V20, this.V21, this.V22 );
        }
        ...
        public Vector3 GetColumn( int index )
        {
            ...
            return ( index == 0 ) ? new Vector3( this.V00, this.V10, this.V20 ) :
                   ( index == 1 ) ? new Vector3( this.V01, this.V11, this.V21 ) : new Vector3( this.V02, this.V12, this.V22 );
        }
        ...
        {
            return
                this.V00.GetHashCode( ) + this.V01.GetHashCode( ) + this.V02.GetHashCode( ) +
                this.V10.GetHashCode( ) + this.V11.GetHashCode( ) + this.V12.GetHashCode( ) +
                this.V20.GetHashCode( ) + this.V21.GetHashCode( ) + this.V22.GetHashCode( );
        }
        ...
        public Matrix3x3 MultiplySelfByTranspose( )
        {
            ...
            m.V00 = this.V00 * this.V00 + this.V01 * this.V01 + this.V02 * this.V02;
            m.V10 = m.V01 = this.V00 * this.V10 + this.V01 * this.V11 + this.V02 * this.V12;
            m.V20 = m.V02 = this.V00 * this.V20 + this.V01 * this.V21 + this.V02 * this.V22;

            m.V11 = this.V10 * this.V10 + this.V11 * this.V11 + this.V12 * this.V12;
            m.V21 = m.V12 = this.V10 * this.V20 + this.V11 * this.V21 + this.V12 * this.V22;

            m.V22 = this.V20 * this.V20 + this.V21 * this.V21 + this.V22 * this.V22;
        ...
        public Matrix3x3 MultiplyTransposeBySelf( )
        {
            ...
            m.V00 = this.V00 * this.V00 + this.V10 * this.V10 + this.V20 * this.V20;
            m.V10 = m.V01 = this.V00 * this.V01 + this.V10 * this.V11 + this.V20 * this.V21;
            m.V20 = m.V02 = this.V00 * this.V02 + this.V10 * this.V12 + this.V20 * this.V22;

            m.V11 = this.V01 * this.V01 + this.V11 * this.V11 + this.V21 * this.V21;
            m.V21 = m.V12 = this.V01 * this.V02 + this.V11 * this.V12 + this.V21 * this.V22;

            m.V22 = this.V02 * this.V02 + this.V12 * this.V12 + this.V22 * this.V22;
        ...
        public Matrix3x3 Adjugate( )
        {
            ...
            m.V00 = this.V11 * this.V22 - this.V12 * this.V21;
            m.V01 = -( this.V01 * this.V22 - this.V02 * this.V21 );
            m.V02 = this.V01 * this.V12 - this.V02 * this.V11;

            m.V10 = -( this.V10 * this.V22 - this.V12 * this.V20 );
            m.V11 = this.V00 * this.V22 - this.V02 * this.V20;
            m.V12 = -( this.V00 * this.V12 - this.V02 * this.V10 );

            m.V20 = this.V10 * this.V21 - this.V11 * this.V20;
            m.V21 = -( this.V00 * this.V21 - this.V01 * this.V20 );
            m.V22 = this.V00 * this.V11 - this.V01 * this.V10;
        ...
        public void SVD( out Matrix3x3 u, out Vector3 e, out Matrix3x3 v )
        {
            ...
            {
                { this.V00, this.V01, this.V02 },
                { this.V10, this.V11, this.V12 },
                { this.V20, this.V21, this.V22 }
            };
            double[,] vArray;
            double[] eArray;
