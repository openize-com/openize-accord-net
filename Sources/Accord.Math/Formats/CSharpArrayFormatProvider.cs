...
namespace FileFormat.Accord.Math.Formats
{
    ...
    public sealed class CSharpArrayFormatProvider : MatrixFormatProviderBase
    {
        ...
        public CSharpArrayFormatProvider(IFormatProvider innerProvider,
            ...
            : base(innerProvider)
        {
            this.FormatMatrixStart = includeTypeName ? "new double[] { " : "{ ";
            this.FormatMatrixEnd = includeSemicolon ? " };" : " }";
            this.FormatRowStart = "";
            this.FormatRowEnd = "";
            this.FormatColStart = "";
            this.FormatColEnd = "";
            ...
            this.ParseMatrixStart = includeTypeName ? "new double[] {" : "{";
            this.ParseMatrixEnd = includeSemicolon ? "};" : "}";
            this.ParseRowStart = "";
            this.ParseRowEnd = "";
            this.ParseColStart = "";
            this.ParseColEnd = "";
