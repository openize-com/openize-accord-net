...
namespace FileFormat.Accord.Math.Decompositions
{
    ...
    public sealed class EigenvalueDecomposition : ICloneable
    {
            ...
            bool inPlace = false, bool sort = false)
        {
            ...
            if (this.symmetric)
            {
                this.V = inPlace ? value : (Double[,])value.Clone();
            ...
            {
                this.H = inPlace ? value : (Double[,])value.Clone();
        ...
        public Double[,] DiagonalMatrix
        {
            get
            {
                ...
                var x = new Double[this.n, this.n];
