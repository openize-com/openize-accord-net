    ...
    public sealed class JaggedQrDecompositionF : ICloneable, ISolverArrayDecomposition<Single>
    {
        ...
        public Single[][] UpperTriangularFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<Single>(rows, this.p);
        ...
        public Single[][] OrthogonalFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<Single>(this.n, cols);
        ...
        public Single[][] Inverse()
        {
            ...
            return this.Solve(Jagged.Diagonal(this.n, this.n, (Single)1));
        }
