    ...
    public sealed class JaggedLuDecomposition : ICloneable, ISolverArrayDecomposition<Double>
    {
        ...
        public Double[][] LowerTriangularFactor
        {
            get
            {
                ...
                {
                    var L = new Double[this.rows][];

                    for (int i = 0; i < this.rows; i++)
                    {
                        L[i] = new Double[this.rows];
        ...
        public Double[][] UpperTriangularFactor
        {
            get
            {
                ...
                {
                    var U = new Double[this.rows][];
                    for (int i = 0; i < this.rows; i++)
                    {
                        U[i] = new Double[this.cols];
        ...
        public Double[][] Inverse()
        {
            ...
            var X = new Double[this.rows][];
            for (int i = 0; i < this.rows; i++)
            {
                X[i] = new Double[this.rows];
