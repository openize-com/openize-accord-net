    ...
    public sealed class EigenvalueDecompositionF : ICloneable
    {
        ...
        public int Rank
        {
            get
            {
                ...
                Single tol = this.n * this.d[0] * eps;
            ...
            bool inPlace = false, bool sort = false)
        {
            ...
            if (this.symmetric)
            {
                this.V = inPlace ? value : (Single[,])value.Clone();
            ...
            {
                this.H = inPlace ? value : (Single[,])value.Clone();

                this.ort = new Single[this.n];
        ...
        public Single[,] DiagonalMatrix
        {
            get
            {
                ...
                var x = new Single[this.n, this.n];
        ...
        public object Clone()
        {
            ...
            clone.e = (Single[])this.e.Clone();
            clone.H = (Single[,])this.H.Clone();
            clone.n = this.n;
            clone.ort = (Single[])this.ort;
            clone.symmetric = this.symmetric;
            clone.V = (Single[,])this.V.Clone();
            return clone;
        }
