...
namespace Openize.Accord.Math.Decompositions
{
    ...
    public sealed class JaggedQrDecompositionD : ICloneable, ISolverArrayDecomposition<Decimal>
    {
            ...
            bool economy = true, bool inPlace = false)
        {
            ...
            this.Rdiag = new Decimal[this.m];

            for (int k = 0; k < this.m; k++)
            {
                // Compute 2-norm of k-th column without under/overflow.
                Decimal nrm = 0;
                for (int i = k; i < this.qr.Length; i++)
        ...
        public Decimal[][] Solve(Decimal[][] value)
        {
            ...
            return Jagged.Create(this.p, count, X, transpose: false);
        }
        ...
        public Decimal[][] SolveTranspose(Decimal[][] value)
        {
            ...
            if (value.Columns() != this.qr.Length)
                throw new ArgumentException("Matrix row dimensions must agree.");
            ...
            return Jagged.Create(count, this.p, X, transpose: true);
        }
        ...
        public Decimal[][] UpperTriangularFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<Decimal>(rows, this.p);
        ...
        public Decimal[][] OrthogonalFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<Decimal>(this.n, cols);
        ...
        public Decimal[][] Inverse()
        {
            ...
            return this.Solve(Jagged.Diagonal(this.n, this.n, (Decimal)1));
        }
