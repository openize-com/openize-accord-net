...
namespace FileFormat.Accord.Math.Kinematics
{
    ...
    public class DenavitHartenbergModel : IEnumerable<DenavitHartenbergJoint>
    {
        ...
        /// </summary>
        /// 
        public DenavitHartenbergJointCollection Joints { get { return this.joints; } }
        ...
        /// </summary>
        /// 
        public Matrix4x4 Transform { get { return this.transformationMatrix; } }
        ...
        public void Compute()
        {
            this.compute(Matrix4x4.Identity, this.position);
        }
        ...
        public void Compute(DenavitHartenbergModel parent)
        {
            ...
            this.compute(parent.Transform, parent.Position);
        }
