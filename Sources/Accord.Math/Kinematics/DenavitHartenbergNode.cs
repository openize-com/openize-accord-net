...
namespace FileFormat.Accord.Math.Kinematics
{
    ...
    public class DenavitHartenbergNode
    {
        ...
        public DenavitHartenbergNode(DenavitHartenbergModel model)
        {
            ...
            this.Children = new DenavitHartenbergNodeCollection(this);
        ...
        public void Compute()
        {
            ...
            {
                this.Model.Compute(this.Parent.Model);
            }

            foreach (DenavitHartenbergNode child in this.Children)
            {
                child.Compute();
            }
        }
    ...
    public class DenavitHartenbergNodeCollection : Collection<DenavitHartenbergNode>
    {
        ...
        {
            this.Add(new DenavitHartenbergNode(child));
        }
