...
namespace Openize.Accord.Statistics.Testing
{
        ...
        IHypothesisTest<EmpiricalDistribution>
    {
            ...
            : this()
        {
            ...
            this.StatisticDistribution = this.GetSimulatedDistribution(hypothesizedDistribution,
                reestimate, iterations, alternate);

            // Finally, compute the test statistic and perform actual testing.
            base.Statistic = KolmogorovSmirnovTest.GetStatistic(orderedSamples, this.TheoreticalDistribution, alternate);
            ...
            bool reestimate, int iterations, KolmogorovSmirnovTestHypothesis alternate)
        {
            ...
            if (reestimate)
            {
                ...
                {
                    double[] s = hypothesizedDistribution.Generate(samples: this.NumberOfSamples);
