...
namespace FileFormat.Accord.Statistics.Testing.Power.TwoSample
{
    using System;
    using Base;
    ...
    public class TwoSampleZTestPowerAnalysis : BaseTwoSamplePowerAnalysis
    {
        ...
        {
            double samples = (this.Samples1 * this.Samples2) / (double)(this.Samples1 + this.Samples2);

            double Za = ZTest.PValueToStatistic(this.Size, this.Tail);
            double Zb = Za - Math.Sqrt(samples) * this.Effect;
        ...
        public override void ComputeSamples(double proportion = 1)
        {
            ...
            this.Samples1 = n * n;
            this.Samples2 = this.Samples1 * proportion;
        }
        ...
        public override void ComputeEffect()
        {
            ...
            double n = Math.Sqrt(this.Samples1 + this.Samples2);
            double d = (Za + Zb) / n;
