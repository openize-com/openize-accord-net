...
namespace Openize.Accord.Statistics.Testing.Multiple_Samples
{
    ...
    public class LeveneTest : FTest
    {
        ...
        {
            this.compute(samples, median ? LeveneTestMethod.Median : LeveneTestMethod.Mean, 0);
        }
        ...
        {
            this.compute(samples, LeveneTestMethod.TruncatedMean, percent);
        }
        ...
        private void compute(double[][] samples, LeveneTestMethod method, double percent)
        {
            ...
            this.Compute(W, degree1, degree2, TwoSampleHypothesis.FirstValueIsGreaterThanSecond);
        }
    }
}
