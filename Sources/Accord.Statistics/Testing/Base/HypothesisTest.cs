...
namespace FileFormat.Accord.Statistics.Testing.Base
{
    using System;
        ...
        where TDistribution : IUnivariateDistribution
    {
        ...
        {
            get { return this.PValue < this.alpha; }
        }
        ...
        {
            get { return this.PValueToStatistic(this.alpha); }
        }
        ...
        {
            return this.PValue.ToString(format, formatProvider);
        }
        ...
        {
            return this.PValue.ToString(System.Globalization.CultureInfo.CurrentCulture);
        }
