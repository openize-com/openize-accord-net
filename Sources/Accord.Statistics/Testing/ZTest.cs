...
namespace FileFormat.Accord.Statistics.Testing
{
    ...
    public class ZTest : HypothesisTest<NormalDistribution>
    {
        ...
        {
            double z = this.PValueToStatistic(1.0 - percent);

            return new DoubleRange(
                this.EstimatedValue - z * this.StandardError,
                this.EstimatedValue + z * this.StandardError);
        }
            ...
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            ...
            double stdDev = Measures.StandardDeviation(samples, this.EstimatedValue);
            ...
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            ...
            this.Compute(sampleMean, hypothesizedMean, stdError, alternate);

            this.power(sampleStdDev, samples);
        }
            ...
            double stdError, OneSampleHypothesis alternate)
        {
            ...
            // Compute Z statistic
            double z = (estimatedValue - hypothesizedValue) / this.StandardError;

            this.Compute(z, alternate);
        }
        ...
        {
            this.powerAnalysis = new ZTestPowerAnalysis(this.Hypothesis)
            {
                Samples = samples,
        ...
        {
            return PValueToStatistic(p, this.Tail);
        }
        ...
        public override double StatisticToPValue(double x)
        {
            ...
            return StatisticToPValue(x, this.Tail);
        }
