...
namespace Openize.Accord.Statistics.Testing
{
        ...
        IHypothesisTest<AndersonDarlingDistribution>
    {
        ...
        public AndersonDarlingTest(double[] sample, IUnivariateDistribution<double> hypothesizedDistribution)
        {
            ...
            {
                this.StatisticDistribution = new AndersonDarlingDistribution(AndersonDarlingDistributionType.Uniform, sample.Length);
            }
            else if (hypothesizedDistribution is NormalDistribution)
            {
                this.StatisticDistribution = new AndersonDarlingDistribution(AndersonDarlingDistributionType.Normal, sample.Length);
            }
            else
            {
            ...
            this.Statistic = GetStatistic(sortedSamples, this.TheoreticalDistribution);
        ...
        public override double StatisticToPValue(double x)
        {
            ...
            return this.StatisticDistribution.ComplementaryDistributionFunction(x);
        }
    }
}