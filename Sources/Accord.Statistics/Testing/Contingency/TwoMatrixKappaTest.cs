...
namespace FileFormat.Accord.Statistics.Testing.Contingency
{
    ...
    public class TwoMatrixKappaTest : TwoSampleZTest
    {
            ...
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            ...
            this.OverallVariance = this.Variance1 + this.Variance2;

            double diff = Math.Abs(this.EstimatedValue1 - this.EstimatedValue2);
            double stdError = Math.Sqrt(this.OverallVariance);
