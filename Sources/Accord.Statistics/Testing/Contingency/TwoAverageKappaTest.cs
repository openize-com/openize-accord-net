...
namespace FileFormat.Accord.Statistics.Testing.Contingency
{
    ...
    public class TwoAverageKappaTest : TwoSampleTTest
    {
            ...
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            ...
            this.Variance1 = varKappa1;
            this.Variance2 = varKappa2;
            ...
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            ...
            this.Variance1 = kappas1.Variance(meanKappa1);
            this.Variance2 = kappas2.Variance(meanKappa2);

            int kappaSamples1 = matrices1.Length;
            int kappaSamples2 = matrices2.Length;

            base.Compute(
               meanKappa1, this.Variance1, kappaSamples1,
               meanKappa2, this.Variance2, kappaSamples2,
               hypothesizedDifference, assumeEqualVariances, alternate);
        }
