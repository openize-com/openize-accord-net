...
namespace Openize.Accord.Statistics.Testing
{
    ...
    public class BinomialTest : HypothesisTest<BinomialDistribution>
    {
            ...
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            ...
            this.Compute(successes, trials.Length, hypothesizedProbability, alternate);
        }
            ...
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            ...
            this.Compute(successes, trials, hypothesizedProbability, alternate);
        }
        ...
        {
            double mean = this.StatisticDistribution.Mean;

            if (x == mean)
                return 1;


            int trials = this.StatisticDistribution.NumberOfTrials;
            ...
            for (int i = 0; i < probabilities.Length; i++)
                probabilities[i] = this.StatisticDistribution.ProbabilityMassFunction(i);
