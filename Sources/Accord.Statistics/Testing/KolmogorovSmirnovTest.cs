...
namespace Openize.Accord.Statistics.Testing
{
        ...
        IHypothesisTest<KolmogorovSmirnovDistribution>
    {
            ...
            KolmogorovSmirnovTestHypothesis alternate = KolmogorovSmirnovTestHypothesis.SampleIsDifferent)
        {
            ...
            this.StatisticDistribution = new KolmogorovSmirnovDistribution(sample.Length);
            ...
            base.Statistic = GetStatistic(sortedSamples, this.TheoreticalDistribution, alternate);
            this.Tail = (DistributionTail)alternate;
            base.PValue = this.StatisticToPValue(this.Statistic);
        }
        ...
        {
            if (this.Tail == DistributionTail.TwoTail)
                return this.StatisticDistribution.ComplementaryDistributionFunction(this.Statistic);
            return this.StatisticDistribution.OneSideDistributionFunction(this.Statistic);
        }
    }
}