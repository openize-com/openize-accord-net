...
namespace FileFormat.Accord.Statistics.Testing.TwoSample
{
    ...
    public class TwoSampleZTest : HypothesisTest<NormalDistribution>
    {
            ...
            double hypothesizedDifference, TwoSampleHypothesis alternate)
        {
            ...
            this.Compute(diff, hypothesizedDifference, stdError, alternate);
        }
            ...
            double standardError, TwoSampleHypothesis alternate)
        {
            ...
            // Compute Z statistic
            double z = (this.ObservedDifference - this.HypothesizedDifference) / this.StandardError;
        ...
        private void power(double var1, double var2, int n1, int n2)
        {
            ...
            this.powerAnalysis = new TwoSampleZTestPowerAnalysis(this.Hypothesis)
            {
                Samples1 = n1,
                Samples2 = n2,
        ...
        {
            return ZTest.PValueToStatistic(p, this.Tail);
        }
        ...
        {
            return ZTest.StatisticToPValue(x, this.Tail);
        }
