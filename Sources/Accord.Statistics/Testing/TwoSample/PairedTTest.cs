...
namespace Openize.Accord.Statistics.Testing.TwoSample
{
    ...
    public class PairedTTest : HypothesisTest<TDistribution>
    {
            ...
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            ...
            this.StandardError = std / Math.Sqrt(n);
            this.ObservedDifference = mean;
            this.Mean1 = sample1.Mean();
            this.Mean2 = sample2.Mean();

            this.SampleSize = n;
            this.Statistic = this.ObservedDifference / this.StandardError;
            this.StatisticDistribution = new TDistribution(n - 1);
