...
namespace FileFormat.Accord.Statistics.Testing.TwoSample
{
    ...
    public class TwoProportionZTest : TwoSampleZTest
    {
            ...
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            ...
            this.Compute(x1, sampleSize1, x2, sampleSize2, alternate);
        }
        ...
        public TwoProportionZTest(int successes1, int trials1, int successes2, int trials2,
            TwoSampleHypothesis alternate = TwoSampleHypothesis.ValuesAreDifferent)
        {
            this.Compute(successes1, trials1, successes2, trials2, alternate);
        }
            ...
            TwoSampleHypothesis alternate)
        {
            ...
            this.EstimatedValue1 = p1;
            this.EstimatedValue2 = p2;
            this.ObservedDifference = p1 - p2;
            this.StandardError = Math.Sqrt(p * (1 - p) * (1.0 / trials1 + 1.0 / trials2));

            double z = this.ObservedDifference / this.StandardError;
