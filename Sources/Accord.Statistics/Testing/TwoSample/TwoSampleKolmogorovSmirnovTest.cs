...
namespace Openize.Accord.Statistics.Testing.TwoSample
{
    ...
    public class TwoSampleKolmogorovSmirnovTest : HypothesisTest<KolmogorovSmirnovDistribution>
    {
            ...
            TwoSampleKolmogorovSmirnovTestHypothesis alternate)
        {
            ...
            this.StatisticDistribution = new KolmogorovSmirnovDistribution(n);

            // Create the two empirical distributions from the data
            this.EmpiricalDistribution1 = new EmpiricalDistribution(sample1, 0);
            this.EmpiricalDistribution2 = new EmpiricalDistribution(sample2, 0);
            ...
            Func<double, double> F = this.EmpiricalDistribution1.DistributionFunction;
            Func<double, double> G = this.EmpiricalDistribution2.DistributionFunction;
            ...
            if (alternate == TwoSampleKolmogorovSmirnovTestHypothesis.SamplesDistributionsAreUnequal)
            {
                ...
                base.PValue = this.StatisticDistribution.ComplementaryDistributionFunction(this.Statistic);
            }
            else if (alternate == TwoSampleKolmogorovSmirnovTestHypothesis.FirstSampleIsLargerThanSecond)
            {
                ...
                base.PValue = this.StatisticDistribution.OneSideDistributionFunction(this.Statistic);
            }
            else
            {
