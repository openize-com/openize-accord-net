...
namespace Openize.Accord.Statistics.Testing
{
        ...
        IHypothesisTest<ShapiroWilkDistribution>
    {
        ...
        public ShapiroWilkTest(double[] sample)
        {
            ...
            this.StatisticDistribution = new ShapiroWilkDistribution(n);
        ...
        {
            return this.StatisticDistribution.InverseDistributionFunction(p);
        }
        ...
        {
            return this.StatisticDistribution.DistributionFunction(x);
        }
    }
}