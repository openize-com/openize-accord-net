...
namespace Openize.Accord.Statistics.Testing
{
    ...
    public class FTest : HypothesisTest<FDistribution>
    {
        ...
        /// </summary>
        /// 
        public int DegreesOfFreedom1 { get { return this.StatisticDistribution.DegreesOfFreedom1; } }
        ...
        /// </summary>
        /// 
        public int DegreesOfFreedom2 { get { return this.StatisticDistribution.DegreesOfFreedom2; } }
        ...
        {
            this.Compute(var1 / var2, d1, d2, alternate);
        }
        ...
        public FTest(double statistic, int d1, int d2,
            TwoSampleHypothesis alternate = TwoSampleHypothesis.FirstValueIsGreaterThanSecond)
        {
            this.Compute(statistic, d1, d2, alternate);
        }
        ...
        public override double StatisticToPValue(double x)
        {
            ...
            switch (this.Tail)
            {
                case DistributionTail.TwoTail:
                    p = 2.0 * this.StatisticDistribution.DistributionFunction(Math.Abs(x));
                    break;
        ...
        public override double PValueToStatistic(double p)
        {
            ...
            {
                case DistributionTail.OneLower:
                    f = this.StatisticDistribution.InverseDistributionFunction(p);
                    break;
                case DistributionTail.OneUpper:
                    f = this.StatisticDistribution.InverseDistributionFunction(1.0 - p);
                    break;
                case DistributionTail.TwoTail:
                    f = this.StatisticDistribution.InverseDistributionFunction(1.0 - p / 2.0);
                    break;
                default:
                    throw new InvalidOperationException();
            }
