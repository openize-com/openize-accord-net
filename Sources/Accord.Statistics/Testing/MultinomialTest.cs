...
namespace Openize.Accord.Statistics.Testing
{
    ...
    public class MultinomialTest : ChiSquareTest
    {
        ...
        public MultinomialTest(double[] sampleProportions, int sampleSize)
        {
            ...
            this.Compute(sampleSize, sampleProportions, hypothesizedProportions);
        }
        ...
        public MultinomialTest(int[] sample, int categories)
        {
            ...
            this.Compute(sample.Length, observed, hypothesizedProportions);
        }
        ...
        protected void Compute(int sampleSize, double[] observed, double[] expected)
        {
            ...
            double sum = 0;
            for (int i = 0; i < this.ObservedProportions.Length; i++)
            {
