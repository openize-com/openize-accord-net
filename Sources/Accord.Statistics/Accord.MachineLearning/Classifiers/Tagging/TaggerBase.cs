...
namespace FileFormat.Accord.Statistics.Accord.MachineLearning.Classifiers.Tagging
{
        ...
        ITagger<TInput>
    {
        ...
        public virtual int NumberOfClasses
        {
            ...
            set { this.NumberOfOutputs = value; }
        }
        ...
        {
            return this.Decide(new[] { input }, new[] { result })[0];
        }
        ...
        public int[][] Decide(TInput[][] input)
        {
            return this.Decide(input, Jagged.CreateAs<TInput, int>(input));
        }
        ...
        internal double[][] create(TInput[] input)
        {
            ...
            for (int j = 0; j < input.Length; j++)
                result[j] = new double[this.NumberOfOutputs];
            return result;
        }
        ...
        internal double[][][] create(TInput[][] input)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                for (int j = 0; j < input[i].Length; j++)
                    result[i][j] = new double[this.NumberOfOutputs];
            }
