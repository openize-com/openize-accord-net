...
namespace FileFormat.Accord.Statistics.Accord.MachineLearning.Classifiers.Tagging
{
        ...
        IScoreTagger<TInput>
    {
        ...
        {
            return this.Scores(new[] { sequence })[0];
        }
        ...
        {
            return this.Scores(new[] { sequence }, new[] { result })[0];
        ...
        {
            var d = new[] { decision };
            return this.Scores(new[] { sequence }, ref d)[0];
        }
        ...
        {
            return this.Scores(sequences, this.create(sequences));
        }
        ...
        {
            return this.Scores(sequences, ref decision, this.create(sequences));
        }
