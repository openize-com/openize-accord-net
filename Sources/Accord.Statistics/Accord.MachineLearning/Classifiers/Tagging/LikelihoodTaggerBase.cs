...
namespace Openize.Accord.Statistics.Accord.MachineLearning.Classifiers.Tagging
{
        ...
        ILikelihoodTagger<TInput>
    {
        ...
        {
            return this.Probability(new[] { sequence })[0];
        }
        ...
        {
            var d = new[] { decision };
            double p = this.Probability(new[] { sequence }, ref d)[0];
            decision = d[0];
            return p;
        }
        ...
        {
            return this.Probability(sequences, new double[sequences.Length]);
        }
        ...
        {
            return this.Probability(sequences, ref decision, new double[sequences.Length]);
        }
        ...
        {
            this.LogLikelihood(sequences, result);
        ...
        {
            this.LogLikelihood(sequences, ref decision, result);
            return Elementwise.Exp(result, result: result);
        }
        ...
        {
            return this.LogLikelihood(new[] { sequence })[0];
        }
        ...
        {
            var d = new[] { decision };
            double l = this.LogLikelihood(new[] { sequence }, ref d)[0];
            decision = d[0];
            return l;
        }
        ...
        {
            return this.LogLikelihood(sequences, new double[sequences.Length]);
        }
        ...
        {
            return this.LogLikelihood(sequences, ref decision, new double[sequences.Length]);
        }
        ...
        {
            return this.Probabilities(sequence, this.create(sequence));
        }
        ...
        {
            this.Probabilities(sequence, result);
            return Elementwise.Exp(result, result: result);
        }
        ...
        {
            return this.Probabilities(sequence, ref decision, this.create(sequence));
        }
        ...
        {
            this.Probabilities(sequence, ref decision, result);
            return Elementwise.Exp(result, result: result);
        }
        ...
        {
            return this.LogLikelihoods(sequence, this.create(sequence));
        }
        ...
        {
            return this.LogLikelihoods(sequence, ref decision, this.create(sequence));
        }
        ...
        {
            return this.Probabilities(sequences, this.create(sequences));
        }
        ...
        {
            this.LogLikelihoods(sequences, result);
        ...
        {
            return this.Probabilities(sequences, ref decision, this.create(sequences));
        }
        ...
        {
            this.LogLikelihoods(sequences, ref decision, result);
            for (int i = 0; i < result.Length; i++)
                Elementwise.Exp(result[i], result: result[i]);
            return result;
        }
        ...
        {
            return this.LogLikelihoods(sequences, this.create(sequences));
        }
        ...
        public virtual double[][][] LogLikelihoods(TInput[][] sequences, double[][][] result)
        {
            for (int i = 0; i < sequences.Length; i++)
                this.LogLikelihoods(sequences[i], result[i]);
            return result;
        }
        ...
        {
            for (int i = 0; i < sequences.Length; i++)
                this.LogLikelihoods(sequences[i], ref decision[i], result[i]);
            return result;
        }
        ...
        {
            return this.LogLikelihoods(sequences, ref decision, this.create(sequences));
        }
        ...
        {
            return this.LogLikelihoods(sequences, result);
        }
        ...
        {
            return this.LogLikelihoods(sequences, ref decision, result);
        }

        double ICovariantTransform<TInput[], double>.Transform(TInput[] input)
        {
            return this.LogLikelihood(input);
        }
