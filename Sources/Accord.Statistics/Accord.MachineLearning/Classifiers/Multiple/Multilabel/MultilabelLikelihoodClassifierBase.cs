...
namespace FileFormat.Accord.Statistics.Accord.MachineLearning.Classifiers.Multiple.Multilabel
{
        ...
        IMulticlassLikelihoodClassifier<TInput>
    {
        ...
        {
            return this.Scores(input, ref decision, result);
        }
        ...
        {
            var decision = new bool[this.NumberOfOutputs];
            var result = new double[this.NumberOfOutputs];
            this.LogLikelihoods(input, ref decision, result);
        ...
        {
            var decision = new bool[this.NumberOfOutputs];
            return this.LogLikelihoods(input, ref decision, result);
        }
        ...
        public double[][] LogLikelihoods(TInput[] input, double[][] result)
        {
            for (int i = 0; i < input.Length; i++)
                result[i] = this.LogLikelihoods(input[i], result[i]);
            return result;
        }
        ...
        {
            int decision;
            return this.Probabilities(input, out decision, result);
        }
        ...
        public double[][] Probabilities(TInput[] input, double[][] result)
        {
            bool[] decision = new bool[this.NumberOfOutputs];
            for (int i = 0; i < input.Length; i++)
                this.Probabilities(input[i], ref decision, result[i]);
            return result;
        }
        ...
        {
            return this.LogLikelihoods(input, ref decision, new double[this.NumberOfOutputs]);
        }
        ...
        public double[] LogLikelihoods(TInput input, ref int[] decision, double[] result)
        {
            ...
            var mask = new bool[this.NumberOfOutputs];
            this.LogLikelihoods(input, ref mask, result);
        ...
        public double[][] LogLikelihoods(TInput[] input, ref bool[][] decision, double[][] result)
        {
            decision = this.createOrReuse(input, decision);
            for (int i = 0; i < input.Length; i++)
                this.LogLikelihoods(input[i], ref decision[i], result[i]);
            return result;
        }
        ...
        public double[][] LogLikelihoods(TInput[] input, ref int[][] decision, double[][] result)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                this.LogLikelihoods(input[i], ref mask, result[i]);
        ...
        {
            return this.Probabilities(input, ref decision, new double[this.NumberOfOutputs]);
        }
        ...
        {
            var mask = new bool[this.NumberOfOutputs];
            this.Probabilities(input, ref mask, result);
        ...
        public double[][] Probabilities(TInput[] input, ref int[] decision, double[][] result)
        {
            this.Probabilities(input, result);
            result.ArgMax(dimension: 1, result: decision);
            return result;
        }
        ...
        public double[][] Probabilities(TInput[] input, ref bool[][] decision, double[][] result)
        {
            decision = this.createOrReuse(input, decision);
            for (int i = 0; i < input.Length; i++)
                this.Probabilities(input[i], ref decision[i], result[i]);
            return result;
        }
        ...
        public double[][] Probabilities(TInput[] input, ref int[][] decision, double[][] result)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                this.Probabilities(input[i], ref mask, result[i]);
                decision[i] = Vector.KHot<int>(mask, decision[i]);
            }
            return result;
        }
        ...
        {
            int decision;
            return this.LogLikelihoods(input, out decision)[decision];
        }
        ...
        double[] IMulticlassLikelihoodClassifier<TInput>.LogLikelihood(TInput[] input, double[] result)
        {
            int d;
            for (int i = 0; i < input.Length; i++)
                result[i] = this.LogLikelihoods(input[i], out d)[d];
            return result;
        }
        ...
        {
            int d;
            double result = this.LogLikelihoods(input, out d)[d];
            decision = d;
            return result;
        }
        ...
        {
            int decision;
            return this.Probabilities(input, out decision)[decision];
        }
        ...
        double[] IMulticlassLikelihoodClassifier<TInput>.Probability(TInput[] input, double[] result)
        {
            int d;
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Probabilities(input[i], out d)[d];
            return result;
        }
        ...
        {
            int d;
            double result = this.Probabilities(input, out d)[d];
            decision = d;
            return result;
        }
