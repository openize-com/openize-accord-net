...
namespace FileFormat.Accord.Statistics.Accord.MachineLearning.Classifiers.Multiple.Multilabel
{
        ...
        IMulticlassScoreClassifier<TInput>
    {
        ...
        {
            bool decision;
            return this.Score(input, classIndex, out decision);
        }
        ...
        public double[] Score(TInput[] input, int[] classIndex, double[] result)
        {
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Score(input[i], classIndex[i]);
            return result;
        }
        ...
        {
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Score(input[i], classIndex);
            return result;
        }
        ...
        {
            return this.Scores(input, new double[this.NumberOfOutputs]);
        }
        ...
        public double[][] Scores(TInput[] input, double[][] result)
        {
            bool[] decision = null;
            for (int i = 0; i < input.Length; i++)
                this.Scores(input[i], ref decision, result[i]);
            return result;
        }
        ...
        {
            return this.Scores(input, ref decision, new double[this.NumberOfOutputs]);
        }
        ...
        public double[] Scores(TInput input, ref int[] decision, double[] result)
        {
            ...
            this.Scores(input, ref mask, result);
        ...
        public double[][] Scores(TInput[] input, ref bool[][] decision, double[][] result)
        {
            decision = this.createOrReuse(input, decision);
            for (int i = 0; i < input.Length; i++)
                this.Scores(input[i], ref decision[i], result[i]);
            return result;
        }
        ...
        public double[][] Scores(TInput[] input, ref int[][] decision, double[][] result)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                this.Scores(input[i], ref mask, result[i]);
        ...
        int IClassifier<TInput, int>.Decide(TInput input)
        {
            ...
            {
                double output = this.Score(input, i);
                if (output > max)
                {
                    max = output;
                    imax = i;
        ...
        {
            return this.Scores(input, out decision, new double[this.NumberOfOutputs]);
        }
        ...
        int[] ICovariantTransform<TInput, int>.Transform(TInput[] input)
        {
            return this.Transform(input, new int[this.NumberOfOutputs]);
        }
        ...
        double[] ICovariantTransform<TInput, double>.Transform(TInput[] input)
        {
            return this.Transform(input, new double[this.NumberOfOutputs]);
        }
        ...
        {
            int decision;
            return this.Scores(input, out decision)[decision];
        }
        ...
        double[] IMulticlassScoreClassifier<TInput>.Score(TInput[] input, double[] result)
        {
            int d;
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Scores(input[i], out d)[d];
            return result;
        }
        ...
        {
            int d;
            double result = this.Scores(input, out d)[d];
            decision = d;
            return result;
        }
