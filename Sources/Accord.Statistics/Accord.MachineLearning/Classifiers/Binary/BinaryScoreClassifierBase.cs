...
namespace Openize.Accord.Statistics.Accord.MachineLearning.Classifiers.Binary
{
        ...
        IBinaryScoreClassifier<TInput>
    {
        ...
        {
            this.Score(input, ref result, result: new double[input.Length]);
            return result;
        }
        ...
        {
            return this.Decide(new[] { input }, result: new bool[1])[0];
        }
        ...
        double[] IMultilabelScoreClassifier<TInput>.Score(TInput[] input, int[] classIndex)
        {
            return this.ToMultilabel().Score(input, classIndex, new double[input.Length]);
        }
        ...
        double[] IMultilabelScoreClassifier<TInput>.Score(TInput[] input, int[] classIndex, double[] result)
        {
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Scores(input[i])[classIndex[i]];
            return result;
        }
        ...
        {
            for (int i = 0; i < input.Length; i++)
                result[i] = this.Scores(input[i])[classIndex];
            return result;
        }
        ...
        {
            return this.Score(new TInput[] { input })[0];
        }
        ...
        {
            return this.Scores(input, new double[this.NumberOfClasses]);
        }
        ...
        public double[] Score(TInput[] input)
        {
            return this.Score(input, new double[input.Length]);
        }
        ...
        public double[][] Scores(TInput[] input)
        {
            return this.Scores(input, this.create<double>(input));
        }
        ...
        {
            return this.Scores(new[] { input }, new[] { result })[0];
        }
        ...
        public double[][] Scores(TInput[] input, double[][] result)
        {
            ...
            {
                p[0] = input[i];
                double d = this.Score(p, result: o)[0];
        ...
        {
            bool[] d = new bool[1];
            double s = this.Score(new TInput[] { input }, ref d)[0];
            decision = d[0];
            return s;
        }
        ...
        {
            return this.Scores(input, out decision, new double[this.NumberOfClasses]);
        }


        double[] IMultilabelOutScoreClassifier<TInput, int>.Scores(TInput input, out int decision)
        {
            return this.ToMultilabel().Scores(input, out decision, new double[this.NumberOfClasses]);
        }
        ...
        {
            return this.ToMultilabel().Scores(input, ref decision, new double[this.NumberOfClasses]);
        }
        ...
        public double[] Scores(TInput input, out bool decision, double[] result)
        {
            bool[] d = new bool[1];
            double[][] r = new[] { result };
            double[] s = this.Scores(new TInput[] { input }, ref d, r)[0];
            decision = d[0];
            return s;
        }
        ...
        {
            return this.ToMulticlass().Score(input, ref decision, new double[input.Length]);
        }
        ...
        {
            return this.Score(input, ref decision, new double[input.Length]);
        }
        ...
        {
            return this.ToMultilabel().Scores(input, ref decision, this.create<double>(input));
        }
        ...
        {
            return this.Scores(input, ref decision, this.create<double>(input));
        }
        ...
        {
            this.ToMultilabel().Scores(input, result);
            decision = this.createOrReuse(input, decision);
        ...
        {
            return this.Scores(input, result);
        }
        ...
        public override double[] Transform(TInput[] input, double[] result)
        {
            return this.Score(input, result);
        }
