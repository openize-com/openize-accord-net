...
namespace FileFormat.Accord.Statistics.Kernels
{
        ...
        where TDistance : IDistance<TInput>, ICloneable
    {
        ...
        {
            this.Gamma = Gaussian.Estimate<TInput, TDistance>(inputs, this.distance).Gamma;
        }
        ...
        public object Clone()
        {
            Gaussian<TDistance, TInput> clone = (Gaussian<TDistance, TInput>)this.MemberwiseClone();
