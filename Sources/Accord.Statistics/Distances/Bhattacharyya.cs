...
namespace FileFormat.Accord.Statistics.Distances
{
        ...
        IDistance<MultivariateNormalDistribution>
    {
        ...
        public double Distance(double[][] x, double[][] y)
        {
            ...
            return this.Distance(meanX, covX, meanY, covY);
        }
        ...
        public double Distance(double[] meanX, double[,] covX, double[] meanY, double[,] covY)
        {
            ...
            return this.Distance(meanX, covX, lnDetX, meanY, covY, lnDetY);
        }
        ...
        {
            return this.Distance(x.Mean, x.Covariance, y.Mean, y.Covariance);
        }
    }
}
