...
namespace FileFormat.Accord.Statistics.Filters.Base
{
    using System;
        ...
        where TFilter : BaseFilter<TOptions, TFilter>
    {
        ...
        protected BaseFilter()
        {
            ...
            this.Columns.AddingNew += this.Columns_AddingNew;
            this.Active = true;
        }
        ...
        public DataTable Apply(DataTable data, params string[] columnNames)
        {
            ...
            if (this.Active)
            {
                return this.ProcessFilter(data.DefaultView.ToTable(false, columnNames));
            }
        ...
        public DataTable Apply(DataTable data)
        {
            ...
            if (this.Active)
            {
                return this.ProcessFilter(data);
            }
        ...
        public TOptions this[int index]
        {
            get
            {
                for (int i = this.Columns.Count; i <= index; i++)
                {
                    this.Columns.Add(new TOptions()
                    {
