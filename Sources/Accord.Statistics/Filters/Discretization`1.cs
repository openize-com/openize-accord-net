        ...
        IUnsupervisedLearning<Discretization<TInput, TOutput>, TInput[], TOutput[]>
    {
            ...
            : this()
        {
            for (int i = 0; i < columns.Length; i++)
                this.Columns.Add(new Options(columns[i]));
        }
        ...
        {
            for (int i = 0; i < columns.Length; i++)
                this.Columns.Add(new Options(columns[i])).Learn(data.GetColumn(i));
        }
        ...
        {
            for (int i = 0; i < columns.Length; i++)
                this.Columns.Add(new Options(columns[i]).Learn(data));
        }
#endif
        ...
        public TOutput[][] Transform(object[][] data)
        {
            ...
            for (int i = 0; i < data.Length; i++)
                result[i] = this.Transform(data[i]);
            return result;
        }
        ...
        public TOutput[][] Transform(TInput[][] input, TOutput[][] result)
        {
            for (int j = 0; j < input.Length; j++)
            {
                ...
                for (int i = 0; i < this.Columns.Count; i++)
                    r[i] = this.Columns[i].Transform(x[i]);
            }
