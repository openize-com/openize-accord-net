...
namespace FileFormat.Accord.Statistics.Filters
{
    ...
    ///   The following code section shows how to create a <see cref="Linear">
    ...
    public class Codification : Codification<string>, IAutoConfigurableFilter, ITransform<string[], double[]>
    {
        ...
        public int[] Transform(string[,] values)
        {
            ...
            for (int i = 0; i < rows; i++)
                result[i] = this.Columns[values[i, 0]].Transform(values[i, 1]);
            return result;
        }
        ...
        {
            return this.Transform(columnName, value);
        }
        ...
        {
            return this.Transform(row, columnNames);
        }
#endif
        ...
        {
            return this.Transform(columnNames, values);
        }
        ...
        {
            return this.Transform(columnName, values);
        }
        ...
        {
            return this.Revert(columnName, codeword);
        }
        ...
        {
            return this.Revert(columnName, codewords);
        }
        ...
        {
            return this.Revert(columnNames, codewords);
        }
        ...
        public void Detect(string columnName, string[][] values)
        {
            this.Detect(columnName, values.Reshape(0));
        }
        ...
        internal class Selector : SurrogateSelector
        {
            ...
            public Selector()
            {
                this.AddSurrogate(typeof(System.DBNull), new StreamingContext(StreamingContextStates.All), new DBNullSerializationSurrogate());
            }
        }
#endif
        #endregion
