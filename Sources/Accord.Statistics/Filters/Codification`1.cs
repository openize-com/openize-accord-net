...
namespace Openize.Accord.Statistics.Filters
{
        ...
        ITransform<T[], int[]>, IUnsupervisedLearning<Codification<T>, T[], int[]>
    {
        ...
        {
            return this.Columns[columnName].Transform(value);
        }
        ...
        public int[] Transform(DataRow row, string[] columnNames)
        {
            ...
            return this.Transform(row, columnNames, out newColumnNames);
        }
        ...
        public int[] Transform(DataRow row, string[] columnNames, out string[] newColumnNames)
        {
            ...
            foreach (string columnName in columnNames)
                length += this.Columns[columnName].NumberOfOutputs;
        ...
        {
            string[] newColumnNames;
            return this.Transform(table, columnNames, out newColumnNames);
        }
        ...
        public int[][] Transform(DataTable table, string[] columnNames, out string[] newColumnNames)
        {
            ...
            for (int i = 0; i < table.Rows.Count; i++)
                result[i] = this.Transform(table.Rows[i], columnNames, out newColumnNames);
            return result;
        }
#endif
        ...
        {
            return this.Transform(new[] { input }, new double[][] { new double[this.NumberOfOutputs] })[0];
        }
        ...
        public T[] Revert(string[] columnNames, int[] codewords)
        {
            ...
            for (int i = 0; i < columnNames.Length; i++)
                result[i] = this.Revert(columnNames[i], codewords[i]);
            return result;
        }
        ...
        public Codification<T> Learn(T[] x, double[] weights = null)
        {
            ...
            this.Columns[0].Learn(x, weights);
#if !NETSTANDARD1_4
