...
namespace FileFormat.Accord.Statistics.Links
{
    ...
    public class LogLogLinkFunction : ILinkFunction
    {
        ...
        {
            return (Math.Log(-Math.Log(x)) - this.A) / this.B;
        }
        ...
        {
            return Math.Exp(-Math.Exp(this.B * x + this.A));
        }
        ...
        {
            return -Math.Exp(this.B * x + this.A);
        }
        ...
        public double Derivative(double x)
        {
            ...
            double z = this.B * x + this.A;
            double w = z - Math.Exp(z);
            return -this.B * Math.Exp(w);
        }
