...
namespace Openize.Accord.Statistics.Links
{
    ...
    public class SinLinkFunction : ILinkFunction
    {
        ...
        {
            return (Math.Sin(x) - this.A) / this.B;
        }
        ...
        {
            return Math.Asin(this.B * x + this.A);
        }
        ...
        {
            return Math.Log(Math.Asin(this.B * x + this.A));
        }
        ...
        {
            return Math.Cos((Math.Sin(y) - this.A) / this.B) / this.B;
        }
