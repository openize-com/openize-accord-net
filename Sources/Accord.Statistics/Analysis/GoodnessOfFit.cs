...
namespace FileFormat.Accord.Statistics.Analysis
{
        ...
        IFormattable
    {
        ...
        public string Name
        {
            get { return this.analysis.DistributionNames[this.index]; }
        }
        ...
        {
            get { return (IFittableDistribution<double>)this.analysis.Distributions[this.index].Clone(); }
        }
        ...
        public double KolmogorovSmirnov
        {
            get
            {
                if (this.analysis.KolmogorovSmirnov[this.index] == null)
                    return Double.NaN;
                return this.analysis.KolmogorovSmirnov[this.index].Statistic;
            }
        }
        ...
        {
            get { return this.analysis.KolmogorovSmirnovRank[this.index]; }
        }
        ...
        public double ChiSquare
        {
            get
            {
                if (this.analysis.ChiSquare[this.index] == null)
                    return Double.NaN;
                return this.analysis.ChiSquare[this.index].Statistic;
            }
        }
        ...
        {
            get { return this.analysis.ChiSquareRank[this.index]; }
        }
        ...
        public double AndersonDarling
        {
            get
            {
                if (this.analysis.AndersonDarling[this.index] == null)
                    return Double.NaN;
                return this.analysis.AndersonDarling[this.index].Statistic;
            }
        }
        ...
        {
            get { return this.analysis.AndersonDarlingRank[this.index]; }
        }
        ...
        {
            return this.ChiSquareRank.CompareTo(other.ChiSquareRank);
        }
        ...
        {
            return this.CompareTo(obj as GoodnessOfFit);
        }
        ...
        {
            return this.analysis.Distributions[this.index].ToString();
        }
        ...
        {
            var dist = this.analysis.Distributions[this.index];
