...
namespace Openize.Accord.Statistics.Distributions.Multivariate.Discrete
{
    ...
    public class HiddenMarkovDistribution : MultivariateDiscreteDistribution
    {
        ...
        {
            get { return new [] {  new IntRange(0, this.model.NumberOfSymbols) }; }
        }
        ...
        {
            return Math.Exp(this.model.LogLikelihood(x));
        }
        ...
        {
            return this.model.LogLikelihood(x);
        }
        ...
        public void Fit(double[][] observations, double[] weights, HiddenMarkovOptions options)
        {
            ...
            options.Learning(this.model, observations, weights);
        }
