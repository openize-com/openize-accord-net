...
namespace FileFormat.Accord.Statistics.Distributions.Multivariate.Continuous
{
        ...
        ISampleableDistribution<double[]>
    {
            ...
            : base(mean.Length)
        {
            ...
            this.volume = num / den * Math.Pow(radius, n);
        }
        ...
        {
            if (Distance.Euclidean(x, this.center) < this.radius)
                return 1 / this.volume;
            return 0;
        }
        ...
        {
            return new UniformBallDistribution(this.center.Copy(), this.radius);
        }
        ...
        {
            double[] normal = new double[this.Dimension + 2];
            ...
            for (int i = 0; i < result.Length; i++)
            {
                ...
                for (int j = 0; j < this.Dimension; j++) // take n dimensions
                    result[i][j] = normal[j] * this.radius + this.center[j];
            }
