        ...
        IFormattable
    {
        ...
        public virtual double[][] Generate(int samples, double[][] result, Random source)
        {
            if (this.generator == null)
                this.generator = new MetropolisHasting(this.Dimension, this.LogProbabilityDensityFunction);

            if (this.generator.RandomSource != source)
                this.generator.RandomSource = source;

            return Elementwise.Round(this.Generate(samples), result: result);
        }
        ...
        {
            return Elementwise.Round(this.Generate(source), result: result);
        }
        ...
        {
            return Elementwise.Round(this.Generate(samples, source), result: result);
        }
