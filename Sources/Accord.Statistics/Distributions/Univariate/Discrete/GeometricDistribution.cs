...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Discrete
{
        ...
        ISampleableDistribution<int>
    {
        ...
        public override double Median
        {
            get
            {
                double median = Math.Ceiling(-1.0 / Math.Log(1 - this.p, 2)) - 1;
        ...
        {
            get { return (1 - this.p) / (this.p * this.p); }
        }
        ...
        {
            get { return (-(1 - this.p) * Math.Log(1 - this.p, 2) - this.p * Math.Log(this.p, 2)) / this.p; }
        }
        ...
        {
             return (int)Random(this.p, source);
        }
        ...
        {
            return Random(this.p, samples, result, source);
        }
        ...
        {
            return new GeometricDistribution(this.p);
        }
