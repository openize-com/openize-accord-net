...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Discrete
{
        ...
        ISampleableDistribution<int>
    {
        ...
        /// </summary>
        /// 
        public double Length { get { return this.n; } }
        ...
        {
            get { return new IntRange(this.a, this.b); }
        }
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            this.a = (int)observations.Min();
            this.b = (int)observations.Max();
        }
        ...
        {
            return new UniformDiscreteDistribution(this.a, this.b);
        }
        ...
        {
            return source.Next(this.a, this.b);
        }
        ...
        {
            for (int i = 0; i < samples; i++)
                result[i] = source.Next(this.a, this.b);
            return result;
        }
    }
}
