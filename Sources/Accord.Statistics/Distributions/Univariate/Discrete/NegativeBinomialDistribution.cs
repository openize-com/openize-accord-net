...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Discrete
{
    ...
    public class NegativeBinomialDistribution : UnivariateDiscreteDistribution
    {
        ...
        {
            get { return (this.p * this.r) / (1 - this.p); }
        }
        ...
        {
            get { return (this.p * this.r) / ((1 - this.p) * (1 - this.p)); }
        }
        ...
        {
            return 1.0 - Beta.Incomplete(k + 1, this.r, 1 - this.p);
        }
        ...
        {
            return Special.Binomial(k + this.r - 1, this.r - 1) * Math.Pow(1 - this.p, k) * Math.Pow(this.p, this.r);
        }
        ...
        {
            return Special.LogBinomial(k + this.r - 1, this.r - 1) + k * Math.Log(1 - this.p) + this.r * Math.Log(this.p);
        }
        ...
        {
            return new NegativeBinomialDistribution(this.r, this.p);
        }
