        ...
        ISampleableDistribution<int>, IUnivariateDistribution<double>, IUnivariateDistribution
    {
        ...
        public override double Median
        {
            get
            {
                ...
                if (this.complement > this.probability)
                {
                    median = 0;
                }
                else if (this.complement < this.probability)
                {
                    median = 1;
                }
                else
                ...
                Debug.Assert(median == this.complement || median == base.Median);
        ...
        {
            get { return this.probability * this.complement; }
        }
        ...
        public override double Entropy
        {
            get
            {
                ...
                {
                    this.entropy = -this.probability * System.Math.Log(this.probability) -
                                   this.complement * System.Math.Log(this.complement);
                }
        ...
        {
            return new BernoulliDistribution(this.probability);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Bernoulli(x; p = {0}, q = {1})",
                ...
                this.complement.ToString(format, formatProvider));
        }
    }
}
