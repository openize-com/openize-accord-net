        ...
        ISampleableDistribution<int>
    {
        ...
        public override double Entropy
        {
            get
            {
                ...
                {
                    this.entropy = 0.5 * System.Math.Log(2.0 * System.Math.PI * this.lambda)
                                   - 1 / (12 * this.lambda)
                                   - 1 / (24 * this.lambda * this.lambda)
                                   - 19 / (360 * this.lambda * this.lambda * this.lambda);
                }
        ...
        {
            return Gamma.UpperIncomplete(k + 1, this.lambda);
        }
        ...
        {
            return (Math.Pow(this.lambda, k) / Special.Factorial(k)) * this.epml;
        }
        ...
        {
            return (k * Math.Log(this.lambda) - Special.LogFactorial(k)) - this.lambda;
        }
        ...
        public override int[] Generate(int samples, int[] result, Random source)
        {
            ...
            {
                for (int i = 0; i < samples; i++)
                    result[i] = knuth(source, this.lambda);
            }
        ...
        public override int Generate(Random source)
        {
            ...
            return knuth(source, this.lambda);
        }
        ...
        {
            return new PoissonDistribution(this.lambda);
        }
