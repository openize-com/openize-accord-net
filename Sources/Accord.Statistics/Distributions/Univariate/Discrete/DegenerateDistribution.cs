...
namespace Openize.Accord.Statistics.Distributions.Univariate.Discrete
{
    ...
    public class DegenerateDistribution : UnivariateDiscreteDistribution
    {
        ...
        /// </summary>
        /// 
        public int Value { get { return this.k0; } }
        ...
        {
            get { return new IntRange(this.k0, this.k0); }
        }
        ...
        {
            return new DegenerateDistribution(this.k0);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Degenerate(x; k0 = {0})",
                this.k0.ToString(format, formatProvider));
        }
