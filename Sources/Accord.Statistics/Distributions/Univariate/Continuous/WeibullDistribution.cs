...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        {
            get { return this.lambda * Gamma.Function(1 + 1 / this.k); }
        }
        ...
        {
            get { return this.lambda * this.lambda * Gamma.Function(1 + 2 / this.k) - this.Mean * this.Mean; }
        }
        ...
        {
            get { return this.lambda * Math.Pow(Math.Log(2.0), 1.0 / this.k); }
        }
        ...
        {
            get { return this.k > 1 ? this.lambda * Math.Pow((this.k - 1) / this.k, 1 / this.k) : 0; }
        }
        ...
        {
            get { return Constants.EulerGamma * (1 - 1 / this.k) + Math.Log(this.lambda / this.k) + 1; }
        }
        ...
        {
            double exp = Math.Exp(-Math.Pow(x / this.lambda, this.k));
            return 1.0 - exp;
        }
        ...
        {
            double a = Math.Pow(x / this.lambda, this.k - 1);
            double b = Math.Exp(-Math.Pow(x / this.lambda, this.k));
            return (this.k / this.lambda) * a * b;
        }
        ...
        {
            return Math.Log(this.k / this.lambda) + (this.k - 1) * Math.Log(x / this.lambda) - Math.Pow(x / this.lambda, this.k);
        }
        ...
        {
            return Math.Pow(this.k * x, this.k - 1);
        }
        ...
        {
            return Math.Exp(-Math.Pow(x, this.k));
        }
        ...
        {
            return Math.Pow(-Math.Log(p), 1 / this.k);
        }
        ...
        {
            return new WeibullDistribution(this.lambda, this.k);
        }
        ...
        {
            return Random(this.k, this.lambda, samples, result, source);
        }
        ...
        {
            return Random(this.k, this.lambda, source);
        }
        ...
        {
            return Random(shape, scale, samples, result, global::FileFormat.Accord.Math.Random.Generator.Random);
        }
        ...
        {
            return Random(shape, scale, global::FileFormat.Accord.Math.Random.Generator.Random);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Weibull(x; λ = {0}, k = {1})",
                this.lambda.ToString(format, formatProvider),
                this.k.ToString(format, formatProvider));
        }
