...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class PowerNormalDistribution : UnivariateContinuousDistribution
    {
        ...
        protected internal override double InnerDistributionFunction(double x)
        {
            ...
            return 1.0 - Math.Pow(phi, this.power);
        }
        ...
        {
            return Normal.Inverse(1.0 - Math.Pow(1.0 - p, 1.0 / this.power));
        }
        ...
        protected internal override double InnerProbabilityDensityFunction(double x)
        {
            ...
            return this.power * pdf * Math.Pow(cdf, this.power - 1);
        }
        ...
        {
            return Math.Log(this.power) + Normal.LogDerivative(x) + (this.power - 1) * Normal.Function(-x);
        }
        ...
        {
            return new PowerNormalDistribution(this.power);
        }
