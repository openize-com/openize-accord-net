...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class InverseGammaDistribution : UnivariateContinuousDistribution
    {
        ...
        public InverseGammaDistribution([Positive] double shape, [Positive] double scale)
        {
            ...
            this.constant = Math.Pow(this.b, this.a) / Gamma.Function(this.a);
        }
        ...
        {
            get { return (this.b * this.b) / ((this.a - 1) * (this.a - 1) * (this.a - 2)); }
        }
        ...
        {
            get { return this.a + Math.Log(this.b * Gamma.Function(this.a)) - (1 + this.a) * Gamma.Digamma(this.a); }
        }
        ...
        {
            return Gamma.UpperIncomplete(this.a, this.b / x);
        }
        ...
        {
            return this.constant * Math.Pow(x, -this.a - 1) * Math.Exp(-this.b / x);
        }
        ...
        protected internal override double InnerLogProbabilityDensityFunction(double x)
        {
            ...
            return Math.Log(this.constant) + (-this.a - 1) * lnx + (-this.b / x);
        }
        ...
        {
            return new InverseGammaDistribution(this.a, this.b);
        }
