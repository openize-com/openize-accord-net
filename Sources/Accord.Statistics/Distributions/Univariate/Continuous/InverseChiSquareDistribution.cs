...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class InverseChiSquareDistribution : UnivariateContinuousDistribution
    {
        ...
        {
            double result = Gamma.UpperIncomplete(this.degreesOfFreedom / 2.0, (1 / (2.0 * x)));
            return result;
        }
        ...
        public override double Mean
        {
            get
            {
                if (this.degreesOfFreedom > 2)
                    return 1.0 / (this.degreesOfFreedom - 2.0);
                return Double.NaN;
            }
        }
        ...
        {
            get { return 1.0 / (this.degreesOfFreedom + 2); }
        }
        ...
        {
            return new InverseChiSquareDistribution(this.degreesOfFreedom);
        }
