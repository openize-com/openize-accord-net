...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>
    {
        ...
        /// </summary>
        /// 
        public double Minimum { get { return this.a; } }

        /// <summary>
        ///   Gets the maximum value of the distribution (b).
        /// </summary>
        /// 
        public double Maximum { get { return this.b; } }

        /// <summary>
        ///   Gets the length of the distribution (b-a).
        /// </summary>
        /// 
        public double Length { get { return this.b - this.a; } }
        ...
        {
            get { return ((this.b - this.a) * (this.b - this.a)) / 12.0; }
        }
        ...
        {
            get { return Math.Log(this.b - this.a); }
        }
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            this.a = observations.Min();
            this.b = observations.Max();
        }
        ...
        {
            return new UniformContinuousDistribution(this.a, this.b);
        }
        ...
        {
            return Random(this.a, this.b, samples, result, source);
        }
        ...
        {
            return Random(this.a, this.b, source);
        }
        ...
        {
            return Random(a, b, samples, new double[samples], global::FileFormat.Accord.Math.Random.Generator.Random);
        }
