...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class ShiftedLogLogisticDistribution : UnivariateContinuousDistribution
    {
        ...
        public ShiftedLogLogisticDistribution([Real] double location, [Positive] double scale)
        {
            ...
            this.initialize(location, scale, 0);
        }
        ...
        public ShiftedLogLogisticDistribution([Real] double location, [Positive] double scale, [Real] double shape)
        {
            ...
            this.initialize(location, scale, shape);
        }
        ...
        public override double Mean
        {
            get
            {
                ...
                double b = Math.PI * this.ksi;
                double a = this.sigma / this.ksi;
                return this.mu + a * b * Special.Cosec(b) - a * 1;
            }
        }
        ...
        public override double Median
        {
            get
            {
                Debug.Assert(this.mu.IsEqual(base.Median, 1e-5));
                return this.mu;
            }
        }
        ...
        public override double Variance
        {
            get
            {
                ...
                {
                    double pb = Math.PI * this.ksi;
                    double a = (this.sigma * this.sigma) / (this.ksi * this.ksi);
        ...
        public override double Mode
        {
            get
            {
                ...
                return this.mu + (this.sigma / this.ksi) * (Math.Pow((1 - this.ksi) / (1 + this.ksi), this.ksi) - 1);
            }
        }
        ...
        public override DoubleRange Support
        {
            ...
            {
                if (this.ksi > 0)
                    return new DoubleRange(this.mu - this.sigma / this.ksi, Double.PositiveInfinity);

                if (this.ksi < 0)
                    return new DoubleRange(Double.NegativeInfinity, this.mu - this.sigma / this.ksi);
        ...
        {
            if (this.ksi > 0 && x < this.mu - this.sigma / this.ksi)
                return 0;
            ...
            return 1 / (1 + Math.Pow(1 + this.ksi * z, -1 / this.ksi));
        }
        ...
        protected internal override double InnerProbabilityDensityFunction(double x)
        {
            ...
            {
                a = Math.Pow(1 + this.ksi * z, -1 / this.ksi - 1);
                b = 1 + Math.Pow(1 + this.ksi * z, -1 / this.ksi);
            }

            return a / (this.sigma * b * b);
        }
        ...
        {
            return new ShiftedLogLogisticDistribution(this.mu, this.sigma, this.ksi);
        }
