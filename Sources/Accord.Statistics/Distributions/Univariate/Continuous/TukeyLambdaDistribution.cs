    ...
    public class TukeyLambdaDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Entropy
        {
            get
            {
                ...
                return NonAdaptiveGaussKronrod
                    .Integrate(this.LogQuantileDensityFunction, lower, upper);
            }
        }
        ...
        public override double Variance
        {
            get
            {
                ...
                double a = 2.0 / (this.lambda * this.lambda);
                double b = 1 / (1 + 2 * this.lambda);
                double c = Gamma.Function(this.lambda + 1);
                double d = Gamma.Function(2 * this.lambda + 2);
                return a * (b - (c * c) / d);
            }
        }
        ...
        public override DoubleRange Support
        {
            ...
            {
                if (this.lambda > 0)
                    return new DoubleRange(-1 / this.lambda, 1 / this.lambda);
        ...
        {
            return BrentSearch.Find(this.InverseDistributionFunction, x, 0, 1, 1e-10);
        }
        ...
        protected internal override double InnerInverseDistributionFunction(double p)
        {
            ...
            double a = Math.Pow(p, this.lambda);
            double b = Math.Pow(1 - p, this.lambda);

            return (a - b) / this.lambda;
        }
        ...
        {
            return Math.Pow(p, this.lambda - 1) + Math.Pow(1 - p, this.lambda - 1);
        }
        ...
        {
            double a = Math.Pow(p, this.lambda - 1);
            double b = Math.Pow(1 - p, this.lambda - 1);
            return Math.Log(a + b);
        }
        ...
        protected internal override double InnerProbabilityDensityFunction(double x)
        {
            ...
            return 1.0 / this.QuantileDensityFunction(this.DistributionFunction(x));
        }
        ...
        {
            return -this.LogQuantileDensityFunction(this.DistributionFunction(x));
        }
        ...
        {
            return new TukeyLambdaDistribution(this.lambda);
        }
