...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class FoldedNormalDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Mean
        {
            get
            {
                double a = this.sigma * Math.Sqrt(2 / Math.PI) * Math.Exp(-(this.mu * this.mu) / (2 * this.sigma2));
                double b = this.mu * (1 - 2 * Normal.Function(-this.mu / this.sigma));
                return a + b;
            }
        }
        ...
        public override double Variance
        {
            get
            {
                ...
                return this.mu * this.mu + this.sigma2 - mean * mean;
            }
        }
        ...
        protected internal override double InnerDistributionFunction(double x)
        {
            ...
            double den = Math.Sqrt(2) * this.sigma;
            double a = (y + this.mu) / den;
            double b = (y - this.mu) / den;
        ...
        {
            double a = (+x - this.mu) / this.sigma;
            double b = (-x - this.mu) / this.sigma;

            return (Normal.Derivative(a) + Normal.Derivative(b)) / this.sigma;
        }
        ...
        {
            return new FoldedNormalDistribution(this.mu, this.sigma2);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "FN(x; μ = {0}, σ² = {1})",
                ...
                this.sigma2.ToString(format, formatProvider));
        }
