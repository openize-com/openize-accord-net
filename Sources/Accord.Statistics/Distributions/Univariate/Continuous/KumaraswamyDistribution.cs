...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class KumaraswamyDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Mean
        {
            get
            {
                double num = this.b * Gamma.Function(1 + (1 / this.a)) * Gamma.Function(this.b);
                double den = Gamma.Function(1 + (1 / this.a) + this.b);
        ...
        public override double Variance
        {
            get
            {
                double alpha = momentGeneratingFunction(2, this.a, this.b);
                double beta = Math.Pow(momentGeneratingFunction(1, this.a, this.b), 2);
                return alpha - beta;
            }
        }
        ...
        public override double Median
        {
            get
            {
                return Math.Pow(1 - Math.Pow(2, -1 / this.b), 1 / this.a);
            }
        }
        ...
        public override double Mode
        {
            get
            {
                ...
                if ((this.a >= 1) && (this.b >= 1) && (this.a != 1 && this.b != 1))
                {
                    double num = this.a - 1;
                    double den = this.a * this.b - 1;
                    return Math.Pow(num / den, 1 / this.a);
                }
        ...
        {
            double xa = Math.Pow(x, this.a);
            return 1 - Math.Pow(1 - xa, this.b);
        }
        ...
        {
            return this.a * this.b * Math.Pow(x, this.a - 1) * Math.Pow(1 - Math.Pow(x, this.a), this.b - 1);
        }
