...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class TDistribution : UnivariateContinuousDistribution, IFormattable
    {
        ...
        {
            get { return (this.DegreesOfFreedom > 1) ? 0 : Double.NaN; }
        }
        ...
        public override double Variance
        {
            get
            {
                if (this.DegreesOfFreedom > 2)
                    return this.DegreesOfFreedom / (this.DegreesOfFreedom - 2);
                else if (this.DegreesOfFreedom > 1)
        ...
        {
            return this.lnconstant - ((this.DegreesOfFreedom + 1) / 2.0) * Special.Log1p((x * x) / this.DegreesOfFreedom);
        }
        ...
        {
            return inverseDistributionLeftTail(this.DegreesOfFreedom, p);
        }
        ...
        {
            return new TDistribution(this.DegreesOfFreedom);
        }
