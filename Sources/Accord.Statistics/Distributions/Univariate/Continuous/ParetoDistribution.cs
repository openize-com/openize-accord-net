...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        IFormattable, ISampleableDistribution<double>
    {
        ...
        {
            get { return (this.alpha * this.xm) / (this.alpha - 1); }
        }
        ...
        {
            get { return (this.xm * this.xm * this.alpha) / ((this.alpha - 1) * (this.alpha - 1) * (this.alpha - 2)); }
        }
        ...
        {
            get { return Math.Log(this.xm / this.alpha) + 1.0 / this.alpha + 1.0; }
        }
        ...
        {
            get { return new DoubleRange(this.xm, Double.PositiveInfinity); }
        }
        ...
        {
            get { return this.xm * Math.Pow(2, 1.0 / this.alpha); }
        }
        ...
        {
            return new ParetoDistribution(this.xm, this.alpha);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Pareto(x; xm = {0}, α = {1})",
                this.xm.ToString(format, formatProvider),
        ...
        public override double[] Generate(int samples, double[] result, Random source)
        {
            ...
            for (int i = 0; i < samples; i++)
                result[i] = this.xm / Math.Pow(result[i], 1.0 / this.alpha);
            return result;
        }
        ...
        public override double Generate(Random source)
        {
            ...
            return this.xm / Math.Pow(u, 1.0 / this.alpha);
        }
    }
}
