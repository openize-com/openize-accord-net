...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>
    {
        ...
        {
            get { return 1.0 / (this.lambda * this.lambda); }
        }
        ...
        public override double Median
        {
            get
            {
                double median = Math.Log(2) / this.lambda;
                Debug.Assert(median == base.Median);
                return median;
            }
        }
        ...
        {
            get { return 1 - Math.Log(this.lambda); }
        }
        ...
        {
            double icdf = -Math.Log(1.0 - p) / this.lambda;
            Debug.Assert(icdf.IsEqual(base.InnerInverseDistributionFunction(p), 1e-6));
            return icdf;
        }
        ...
        {
            return new ExponentialDistribution(this.lambda);
        }
        ...
        {
            return Random(this.lambda, samples, result, source);
        }
        ...
        {
            return Random(this.lambda, source);
        }
