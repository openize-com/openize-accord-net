...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class SkewNormalDistribution : UnivariateContinuousDistribution
    {
        ...
        {
            this.initialize(this.ksi, this.omega, this.alpha);
        }
        ...
        {
            this.initialize(location, this.omega, this.alpha);
        }
        ...
        public SkewNormalDistribution([Real] double location, [Positive] double scale)
        {
            ...
            this.initialize(location, scale, this.alpha);
        }
        ...
        {
            get { return this.ksi + this.omega * this.delta * Math.Sqrt(2.0 / Math.PI); }
        }
        ...
        {
            get { return this.omega * this.omega * (1 - (2 * this.delta * this.delta) / Math.PI); }
        }
        ...
        public double Skewness
        {
            get
            {
                ...
                double b = this.delta * Math.Sqrt(2.0 / Math.PI);
                double c = 1 - 2 * this.delta * this.delta / Math.PI;
        ...
        {
            return new SkewNormalDistribution(this.ksi, this.omega, this.alpha);
        }
