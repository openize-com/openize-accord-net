...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>
    {
        ...
        {
            get { return this.degreesOfFreedom; }
        }
        ...
        {
            return Gamma.LowerIncomplete(this.degreesOfFreedom / 2.0, x / 2.0);
        }
        ...
        {
            return Gamma.UpperIncomplete(this.degreesOfFreedom / 2.0, x / 2.0);
        }
        ...
        {
            return Gamma.InverseLowerIncomplete(this.degreesOfFreedom / 2.0, p) * 2.0;
        }
        ...
        {
            get { return 2.0 * this.degreesOfFreedom; }
        }
        ...
        {
            get { return Math.Max(this.degreesOfFreedom - 2, 0); }
        }
        ...
        public override double Entropy
        {
            get
            {
                ...
                {
                    double kd2 = this.degreesOfFreedom / 2.0;
        ...
        {
            return new ChiSquareDistribution(this.degreesOfFreedom);
        }
        ...
        {
            return Random(this.degreesOfFreedom, samples, result, source);
        }
        ...
        {
            return Random(this.degreesOfFreedom, source);
        }
