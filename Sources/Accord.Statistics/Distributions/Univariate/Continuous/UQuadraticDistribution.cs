...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class UQuadraticDistribution : UnivariateContinuousDistribution
    {
        ...
        {
            get { return (3.0d / 20.0d) * Math.Pow(this.b - this.a, 2.0d); }
        }
        ...
        {
            return (this.alpha / 3) * (Math.Pow(x - this.beta, 3) + Math.Pow(this.beta - this.a, 3));
        }
        ...
        {
            return this.alpha * Math.Pow(x - this.beta, 2);
        }
