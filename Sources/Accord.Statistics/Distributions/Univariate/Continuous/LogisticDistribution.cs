...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class LogisticDistribution : UnivariateContinuousDistribution
    {
        ...
        /// </summary>
        /// 
        public double Location { get { return this.mu; } }
        ...
        public override double Median
        {
            get
            {
                Debug.Assert(this.mu == base.Median);
                return this.mu;
            }
        }
        ...
        {
            get { return (this.s * this.s * Math.PI * Math.PI) / 3.0; }
        }
        ...
        protected internal override double InnerLogProbabilityDensityFunction(double x)
        {
            ...
            double result = -z - (Math.Log(this.s) + 2 * Special.Log1p(Math.Exp(-z)));
        ...
        {
            return new LogisticDistribution(this.mu, this.s);
        }
