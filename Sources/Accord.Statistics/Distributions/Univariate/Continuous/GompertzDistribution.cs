    ...
    public class GompertzDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Mode
        {
            get
            {
                ...
                return (1 / this.b) * Math.Log(1 / this.eta);
            }
        }
        ...
        public override double Median
        {
            get
            {
                return (1.0 / this.b) * Math.Log((-1 / this.eta) * Math.Log(0.5) + 1);
            }
        }
        ...
        {
            double ebx = Math.Exp(this.b * x);
            
            double cdf = 1.0 - Math.Exp(-this.eta * (ebx - 1.0));
        ...
        {
            double a1 = this.b * this.eta * Math.Exp(this.eta);
            double a2 = Math.Exp(this.b * x);
            double a3 = Math.Exp(-this.eta * Math.Exp(this.b * x));
            return a1 * a2 * a3;
        }
        ...
        {
            double a1 = Math.Log(this.b * this.eta) + this.eta;
            double a2 = this.b * x;
            double a3 = -this.eta * Math.Exp(this.b * x);
            return a1 + a2 + a3;
        }
        ...
        {
            return new GompertzDistribution(this.eta, this.b);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Gompertz(x; η = {0}, b = {1})",
                this.eta.ToString(format, formatProvider),
