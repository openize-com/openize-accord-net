...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        public override double Median
        {
            get
            {
                Debug.Assert(this.location.IsEqual(base.Median, 1e-6));
        ...
        {
            get { return Math.Log(this.scale) + Math.Log(4.0 * Math.PI); }
        }
        ...
        {
            return 1.0 / Math.PI * Math.Atan2(x - this.location, this.scale) + 0.5;
        }
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            this.Fit(observations, weights, cauchyOptions);
        }
        ...
        public void Fit(double[] observations, double[] weights, CauchyOptions options)
        {
            ...
            double t0 = this.location;
            double s0 = this.scale;
            ...
            this.init(t0, s0); // Become the new distribution
        }
        ...
        {
            return new CauchyDistribution(this.location, this.scale);
        }
        ...
        {
            return Random(this.location, this.scale, samples, result, source);
        }
        ...
        {
            return Random(this.location, this.scale, source);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Cauchy(x; x0 = {0}, γ = {1})",
                this.location.ToString(format, formatProvider),
                this.scale.ToString(format, formatProvider));
        }
    }
}
