...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        IFittableDistribution<double, CauchyOptions>
    {
        ...
        {
            get { return 1 - Math.Exp(-this.gamma); }
        }
        ...
        {
            get { return Math.Log(2 * Math.PI * (1 - Math.Exp(-2 * this.gamma))); }
        }
        ...
        protected internal override double InnerProbabilityDensityFunction(double x)
        {
            ...
            return constant * Math.Sinh(this.gamma) / (Math.Cosh(this.gamma) - Math.Cos(x - this.mu));
        }
        ...
        {
            return new WrappedCauchyDistribution(this.mu, this.gamma);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "WrappedCauchy(x; μ = {0}, γ = {1})",
                ...
                this.gamma.ToString(format, formatProvider));
        }
