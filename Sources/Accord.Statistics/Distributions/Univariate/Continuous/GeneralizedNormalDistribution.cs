...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class GeneralizedNormalDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double Median
        {
            get
            {
                Debug.Assert(this.mean.IsEqual(base.Median, 1e-5));
                return this.mean;
            }
        }
        ...
        {
            get { return this.alpha * this.alpha * Gamma.Function(3.0 / this.beta) / Gamma.Function(1.0 / this.beta); }
        }
        ...
        public override double Entropy
        {
            get
            {
                double a = 1.0 / this.beta;
                double b = this.beta / (2 * this.alpha * Gamma.Function(a));
                return a - Math.Log(b);
            }
        }
        ...
        protected internal override double InnerDistributionFunction(double x)
        {
            ...
            double w = Math.Abs(z) / this.alpha;

            double u = Math.Pow(w, this.beta);
            double b = Gamma.LowerIncomplete(1.0 / this.beta, u);
        ...
        {
            double z = Math.Abs(x - this.mean) / this.alpha;

            double a = this.beta / (2 * this.alpha * Gamma.Function(1 / this.beta));
            double b = Math.Pow(z, this.beta);
        ...
        {
            return new GeneralizedNormalDistribution(this.mean, this.alpha, this.beta);
        }
