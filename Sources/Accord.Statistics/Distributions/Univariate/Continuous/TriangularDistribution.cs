...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFittableDistribution<double, TriangularOptions>
    {
        ...
        /// </summary>
        /// 
        public double Min { get { return this.a; } }

        /// <summary>
        ///   Gets the triangular parameter B (the maximum value).
        /// </summary>
        /// 
        public double Max { get { return this.b; } }
        ...
        {
            get { return (this.a + this.b + this.c) / 3.0; }
        }
        ...
        public override double Median
        {
            ...
            {
                double median;
                if (this.c >= (this.a + this.b) / 2.0)
                {
                    median = this.a + Math.Sqrt((this.b - this.a) * (this.c - this.a)) / Constants.Sqrt2;
                }
                else
                {
                    median = this.b - Math.Sqrt((this.b - this.a) * (this.b - this.c)) / Constants.Sqrt2;
                }

                Debug.Assert(median.IsEqual(base.Median, 1e-5));
        ...
        {
            get { return (this.a * this.a + this.b * this.b + this.c * this.c - this.a * this.b - this.a * this.c - this.b * this.c) / 18; }
        }
        ...
        {
            get { return new DoubleRange(this.a, this.b); }
        }
        ...
        {
            get { return 0.5 + Math.Log((this.b - this.a) / 2); }
        }
        ...
        protected internal override double InnerDistributionFunction(double x)
        {
            ...
            return 1 - ((this.b - x) * (this.b - x)) / ((this.b - this.a) * (this.b - this.c));
        }
        ...
        {
            return new TriangularDistribution(this.a, this.b, this.c);
        }
        ...
        {
            double Fc = this.DistributionFunction(this.c);
            ...
            for (int i = 0; i < samples; i++)
            {
                ...
                if (u < Fc)
                    result[i] = this.a + Math.Sqrt(u * (this.b - this.a) * (this.c - this.a));
                else
                    result[i] = this.b - Math.Sqrt((1 - u) * (this.b - this.a) * (this.b - this.c));
            }
        ...
        public override double Generate(Random source)
        {
            ...
            if (u < Fc)
                return this.a + Math.Sqrt(u * (this.b - this.a) * (this.c - this.a));
            return this.b - Math.Sqrt((1 - u) * (this.b - this.a) * (this.b - this.c));
        }
        ...
        {
            this.Fit(observations, weights, options as TriangularOptions);
        }
