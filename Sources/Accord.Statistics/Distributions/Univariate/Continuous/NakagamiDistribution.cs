...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        private void init(double shape, double spread)
        {
            ...
            double twoMuMu = 2.0 * Math.Pow(this.mu, this.mu);
            double gammaMu = Gamma.Function(this.mu);
            double spreadMu = Math.Pow(this.omega, this.mu);
            this.nratio = -this.mu / this.omega;
            this.twoMu1 = 2.0 * this.mu - 1.0;
        ...
        public override double Mode
        {
            get
            {
                ...
                double b = ((2 * this.mu - 1) * this.omega) / this.mu;
        ...
        {
            return new NakagamiDistribution(this.mu, this.omega);
        }
        ...
        {
            return Random(this.mu, this.omega, samples, result, source);
        }
        ...
        {
            return Random(this.mu, this.omega, source);
        }
