...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class KolmogorovSmirnovDistribution : UnivariateContinuousDistribution, IFormattable
    {
        ...
        {
            get { return new DoubleRange(0.5 / this.NumberOfSamples, 1.0); }
        }
        ...
        {
            get { return Constants.SqrtHalfPI * Constants.Log2 / Math.Sqrt(this.NumberOfSamples); }
        }
        ...
        {
            get { return ((Math.PI * Math.PI) / 12 - (this.Mean * this.Mean)) / this.NumberOfSamples; }
        }
        ...
        {
            return CumulativeFunction(this.NumberOfSamples, x);
        }
        ...
        {
            return ComplementaryDistributionFunction(this.NumberOfSamples, x);
        }
        ...
        {
            return OneSideUpperTail(this.NumberOfSamples, x);
        }
        ...
        {
            return new KolmogorovSmirnovDistribution(this.NumberOfSamples);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "KS(x; n = {0})", 
                this.NumberOfSamples.ToString(format, formatProvider));
        }
