...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class LaplaceDistribution : UnivariateContinuousDistribution, IFormattable
    {
        ...
        {
            get { return Math.Log(2 * Math.E * this.b); }
        }
        ...
        {
            return 0.5 * (1 + Math.Sign(x - this.u) * (1 - Math.Exp(-Math.Abs(x - this.u) / this.b)));
        }
        ...
        {
            return new LaplaceDistribution(this.u, this.b);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "Laplace(x; μ = {0}, b = {1})", 
                this.u.ToString(format, formatProvider),
