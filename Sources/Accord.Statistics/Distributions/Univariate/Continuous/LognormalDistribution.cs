...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        {
            return Random(location, shape, samples, global::Openize.Accord.Math.Random.Generator.Random);
        }
        ...
        {
            return Random(location, shape, samples, result, global::Openize.Accord.Math.Random.Generator.Random);
        }
