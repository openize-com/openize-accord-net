...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        {
            this.initialize(this.location, this.shape, this.shape * this.shape);
        }
        ...
        {
            this.initialize(location, this.shape, this.shape * this.shape);
        }
        ...
        {
            this.initialize(location, shape, shape * shape);
        }
        ...
        public override double Variance
        {
            get
            {
                if (this.variance == null)
                    this.variance = (Math.Exp(this.shape2) - 1.0) * Math.Exp(2 * this.location + this.shape2);
        ...
        {
            get { return Math.Exp(this.location - this.shape2); }
        }
        ...
        public override double Entropy
        {
            get
            {
                if (this.entropy == null)
                    this.entropy = 0.5 + 0.5 * Math.Log(2.0 * Math.PI * this.shape2) + this.location;
        ...
        ///  as <see cref="Special.Erfc">erfc</see>(-z/sqrt(2)) / 2. See 
        ...
        {
            return new LognormalDistribution(this.location, this.shape);
        }
        ...
        {
            return Random(this.location, this.shape, samples, result, source);
        }
        ...
        {
            return Random(this.location, this.shape, source);
        }
        ...
        {
            return Random(location, shape, samples, global::FileFormat.Accord.Math.Random.Generator.Random);
        }
        ...
        {
            return Random(location, shape, samples, result, global::FileFormat.Accord.Math.Random.Generator.Random);
        }
