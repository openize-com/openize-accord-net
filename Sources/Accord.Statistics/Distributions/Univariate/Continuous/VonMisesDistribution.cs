...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        IFittableDistribution<double, VonMisesOptions>
    {
        ...
        {
            this.initialize(0, concentration);
        }
        ...
        {
            this.initialize(mean, concentration);
        }
        ...
        private void initialize(double m, double k)
        {
            ...
            this.variance = null;
            this.constant = 1.0 / (2.0 * Math.PI * Bessel.I0(this.kappa));
        }
        ...
        public override double Variance
        {
            get
            {
                ...
                {
                    double i1 = Bessel.I(1, this.kappa);
                    double i0 = Bessel.I0(this.kappa);
                    double a = i1 / i0;
                    this.variance = 1.0 - a;
                }
        ...
        public override double Entropy
        {
            get
            {
                if (!this.entropy.HasValue)
                {
                    ...
                    double i0 = Bessel.I0(this.kappa);
                    double a = i1 / i0;
                    this.entropy = -this.kappa * a + Math.Log(2 * Math.PI * i0);
                }
        ...
        {
            get { return new DoubleRange(this.mean - Math.PI, this.mean + Math.PI); }
        }
        ...
        {
            return DistributionFunction(x, this.mean, this.kappa);
        }
        ...
        protected internal override double InnerProbabilityDensityFunction(double x)
        {
            ...
            return this.constant * Math.Exp(this.kappa * Math.Cos(z));
        }
        ...
        {
            return Math.Log(this.constant) + this.kappa * Math.Cos(x - this.mean);
        }
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            this.Fit(observations, weights, misesOptions);
        }
        /// <summary>
        ///   Fits the underlying distribution to a given set of observations.
        /// </summary>
        ...
        {
            return new VonMisesDistribution(this.mean, this.kappa);
        }
        ...
        public override string ToString(string format, IFormatProvider formatProvider)
        {
            return String.Format(formatProvider, "VonMises(x; μ = {0}, κ = {1})",
                ...
                this.kappa.ToString(format, formatProvider));
        }
