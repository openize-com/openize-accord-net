...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class GrubbDistribution : UnivariateContinuousDistribution
    {
        ...
        public override DoubleRange Support
        {
            get
            {
                return new DoubleRange(this.InnerInverseDistributionFunction(0), (this.NumberOfSamples - 1.0) / Math.Sqrt(this.NumberOfSamples));
            }
        }
        ...
        protected internal override double InnerDistributionFunction(double x)
        {
            ...
            double p = this.tDistribution.ComplementaryDistributionFunction(t);
            double r = 1.0 - N * p;
            if (r > 1)
                return 1;
            if (r < 0)
        ...
        protected internal override double InnerInverseDistributionFunction(double p)
        {
            ...
            double N = this.NumberOfSamples;
            double t = this.tDistribution.InverseDistributionFunction((1 - p) / N);
        ...
        {
            return new GrubbDistribution(this.NumberOfSamples);
        }
        ...
        {
            return String.Format("Grubb(x; n = {0})", this.NumberOfSamples);
        }
    }
}
