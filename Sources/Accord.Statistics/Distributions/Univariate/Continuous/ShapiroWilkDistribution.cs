...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
    ...
    public class ShapiroWilkDistribution : UnivariateContinuousDistribution, IFormattable
    {
        ...
        {
            get { return this.h(this.normal.Mean); }
        }
        ...
        {
            get { return this.h(this.normal.Mode); }
        }
        ...
        {
            get { return this.h(this.normal.Median); }
        }
        ...
        {
            double z = this.g(x);
            double cdf = this.normal.ComplementaryDistributionFunction(z);
            return cdf;
        }
        ...
        {
            double z = this.g(x);
            return this.normal.DistributionFunction(z);
        }
        ...
        {
            double z = this.g(x);
            return this.normal.ProbabilityDensityFunction(z);
        }
        ...
        {
            double z = this.g(x);
            return this.normal.LogProbabilityDensityFunction(z);
        }
        ...
        {
            return new ShapiroWilkDistribution(this.NumberOfSamples);
        }
