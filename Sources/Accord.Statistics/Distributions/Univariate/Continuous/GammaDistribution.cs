...
namespace FileFormat.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>
    {
        ...
        {
            get { return this.k + Math.Log(this.theta) + Gamma.Log(this.k) + (1 - this.k) * Gamma.Digamma(this.k); }
        }
        ...
        {
            return Gamma.LowerIncomplete(this.k, x / this.theta);
        }
        ...
        {
            return this.lnconstant + (this.k - 1) * Math.Log(x) - x / this.theta;
        }
        ...
        {
            return Gamma.InverseLowerIncomplete(this.k, p) * this.theta;
        }
        ...
        {
            this.Fit(observations, weights, (GammaOptions)options);
        }
        ...
        {
            return new GammaDistribution(this.theta, this.k);
        }
        ...
        {
            return Random(this.k, this.theta, samples, source);
        }
        ...
        {
            return Random(this.k, this.theta, source);
        }
        ...
        {
            return Random(shape, scale, samples, new double[samples], global::FileFormat.Accord.Math.Random.Generator.Random);
        }
        ...
        {
            return Marsaglia(d, c, global::FileFormat.Accord.Math.Random.Generator.Random);
        }
