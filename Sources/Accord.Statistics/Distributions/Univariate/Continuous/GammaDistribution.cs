...
namespace Openize.Accord.Statistics.Distributions.Univariate.Continuous
{
        ...
        ISampleableDistribution<double>
    {
        ...
        {
            return Random(shape, scale, samples, new double[samples], global::Openize.Accord.Math.Random.Generator.Random);
        }
        ...
        {
            return Marsaglia(d, c, global::Openize.Accord.Math.Random.Generator.Random);
        }
