...
namespace Openize.Accord.Statistics.Distributions.Fitting
{
    ...
    /// <summary>
    ///   Estimation options for <see cref="Mixture{T}">univariate</see>
    ///   and <see cref="MultivariateMixture{T}">multivariate</see> 
    ///   <see cref="IMixture{TDistribution}">mixture distributions</see>.
    /// </summary>
    /// 
    [Serializable]
