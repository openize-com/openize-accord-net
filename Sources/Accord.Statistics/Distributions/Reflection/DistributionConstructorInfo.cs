    ...
    public class DistributionConstructorInfo
    {
        ...
        public bool IsBuildable
        {
            get
            {
                if (this.isBuildable == null)
                    this.isBuildable = this.GetParameters().All(x => x.IsBuildable);
        ...
        public DistributionParameterInfo[] GetParameters()
        {
            if (this.parameters == null)
                this.parameters = this.ConstructorInfo.GetParameters().Select(p => new DistributionParameterInfo(p)).ToArray();
