...
namespace Openize.Accord.Statistics.Distributions.Reflection
{
    ...
    public class DistributionInfo
    {
        ...
        public bool IsBuildable
        {
            get
            {
                if (this.isBuildable == null)
                    this.isBuildable = this.GetConstructors().Any(x => x.IsBuildable);
                return this.isBuildable.Value;
            }
        }
        ...
        public bool IsDiscrete
        {
            ...
            {
#if NETSTANDARD
                var distributionTypeInfo = this.DistributionType.GetTypeInfo();
        ...
        {
#if NETSTANDARD
            get { return typeof(IUnivariateDistribution).GetTypeInfo().IsAssignableFrom(this.DistributionType.GetTypeInfo()); }
#else
        ...
        {
#if NETSTANDARD
            get { return typeof(IMultivariateDistribution).GetTypeInfo().IsAssignableFrom(this.DistributionType.GetTypeInfo()); }
#else
        ...
        public DistributionConstructorInfo[] GetConstructors()
        {
            ...
            var typeInfo = this.DistributionType.GetTypeInfo();
        ...
        {
            return GetFittingOptions(this.DistributionType);
        }
