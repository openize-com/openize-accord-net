...
namespace Openize.Accord.Statistics.Models.Markov
{
        ...
        IEnumerable<HiddenMarkovModel<TDistribution>>, IHiddenMarkovClassifier where TDistribution : IDistribution
    {
        ...
        {
            get { return this.Models[0].Dimension; }
        }
            ...
            : base(classes)
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(states[i], initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology, initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology, initial[i]);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology[i], initial[i]);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology[i], initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology[i], initial) { Tag = names[i] };
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution>(topology, initial) { Tag = names[i] };
        }
