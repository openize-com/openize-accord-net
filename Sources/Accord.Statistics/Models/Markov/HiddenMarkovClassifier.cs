...
#pragma warning restore 612, 618
    {
            ...
            : base(classes)
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(topology, symbols) { Tag = names[i] };
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(topology, symbols);
        }
            ...
            : base(classes)
        {
            ...
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(topology[i], symbols);
        }
            ...
            : base(classes)
        {
            ...
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(topology[i], symbols) { Tag = names[i] };
        }
            ...
            : base(classes)
        {
            ...
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(new Ergodic(states[i]), symbols) { Tag = names[i] };
        }
            ...
            : base(classes)
        {
            ...
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel(new Ergodic(states[i]), symbols);
        }
        #endregion
