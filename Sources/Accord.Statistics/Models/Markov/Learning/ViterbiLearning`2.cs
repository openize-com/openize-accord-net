...
namespace FileFormat.Accord.Statistics.Models.Markov.Learning
{
        ...
        where TDistribution : IFittableDistribution<TObservation>
    {
        ...
        {
            get { return this.mle.FittingOptions; }
            set { this.mle.FittingOptions = value; }
        }
        ...
        {
            get { return this.mle.UseLaplaceRule; }
            set { this.mle.UseLaplaceRule = value; }
        }
        ...
        {
            get { return this.mle.Token; }
            set { this.mle.Token = value; }
        }
