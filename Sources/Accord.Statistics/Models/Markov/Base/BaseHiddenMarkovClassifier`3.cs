...
namespace FileFormat.Accord.Statistics.Models.Markov.Base
{
        ...
        where TDistribution : IDistribution<TObservation>
    {
        ...
        {
            int decision;
            return this.LogLikelihood(input, out decision);
        }
        ...
        {
            int decision;
            return this.Probability(input, out decision);
        }
        ...
        {
            int decision;
            return this.LogLikelihoods(input, out decision)[classIndex];
        }
        ...
        {
            this.LogLikelihoods(input, out decision, result);
        ...
        public override double[] LogLikelihoods(TObservation[] input, out int decision, double[] result)
        {
            ...
            for (int i = 0; i < this.models.Length; i++)
                r[i] = this.models[i].LogLikelihood(o) + Math.Log(this.classPriors[i]);
            ...
            if (this.threshold != null)
            {
                ...
                double rejection = this.threshold.LogLikelihood(o) + Math.Log(this.weight);
        ...
        {
            int decision;
            this.LogLikelihoods(input, out decision);
            return decision;
        }
