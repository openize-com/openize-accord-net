        ...
        where TDistribution : IDistribution<TObservation>
    {
            ...
            : base(classes)
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology, (stateIndex) => initial(i, stateIndex));
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(states[i], initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology, initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology, initial[i]);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology[i], initial[i]);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology[i], initial);
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology[i], initial) { Tag = names[i] };
        }
        ...
        {
            for (int i = 0; i < classes; i++)
                this.Models[i] = new HiddenMarkovModel<TDistribution, TObservation>(topology, initial) { Tag = names[i] };
        }
