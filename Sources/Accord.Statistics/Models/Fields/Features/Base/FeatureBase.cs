...
namespace FileFormat.Accord.Statistics.Models.Fields.Features.Base
{
    using System;
    ...
    public abstract class FeatureBase<T>
    {
        ...
        {
            double z = this.Compute(-1, states[0], observations, 0, output);
            for (int t = 1; t < observations.Length; t++)
                z += this.Compute(states[t - 1], states[t], observations, t, output);
