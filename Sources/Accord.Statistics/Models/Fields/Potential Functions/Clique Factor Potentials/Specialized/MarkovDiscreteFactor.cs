...
namespace FileFormat.Accord.Statistics.Models.Fields.Potential_Functions.Clique_Factor_Potentials.Specialized
{
    using System;
    using Base;
    ...
    public class MarkovDiscreteFactor : FactorPotential<int>
    {
        ...
        public override double Compute(int previousState, int currentState, int[] observations, int index, int outputClass = 0)
        {
            ...
            int bindex = this.StateParameters.Offset + currentState * this.Symbols + observations[index];
