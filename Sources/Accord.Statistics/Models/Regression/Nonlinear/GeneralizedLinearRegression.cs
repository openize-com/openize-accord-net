...
#pragma warning restore 0649
        ...
        {
            get { return this.Linear.NumberOfInputs; }
            set
            {
                this.Linear.NumberOfInputs = value;
        ...
        {
            get { return this.Intercept.Concatenate(this.Weights); }
        }
        ...
        {
            get { return this.Linear.NumberOfParameters; }
        }
        ...
        {
            get { return this.Linear.Weights; }
            set { this.linear.Weights = value; }
        }
        ...
        public ILinkFunction Link
        {
            ...
            protected set { this.linkFunction = value; }
        }
        ...
        public MultipleLinearRegression Linear
        {
            ...
            protected set { this.linear = value; }
        }
        ...
        {
            get { return this.linear.Intercept; }
            set { this.linear.Intercept = value; }
        }
        ...
        public WaldTest GetWaldTest(int index)
        {
            ...
            return new WaldTest(this.GetCoefficient(index), 0.0, this.standardErrors[index]);
        }
        ...
        public double GetLogLikelihood(double[][] input, double[] output)
        {
            ...
            {
                double actualOutput = this.Probability(input[i]);
        ...
        {
            return -2.0 * this.GetLogLikelihood(input, output, weights);
        }
        ...
        public ChiSquareTest ChiSquare(double[][] input, double[] output)
        {
            ...
            var regression = new GeneralizedLinearRegression(this.linkFunction)
            {
            ...
            return new ChiSquareTest(ratio, this.NumberOfInputs);
        }
        ...
        public ChiSquareTest ChiSquare(double[][] input, double[] output, double[] weights)
        {
            ...
            double ratio = this.GetLogLikelihoodRatio(input, output, weights, regression);
            return new ChiSquareTest(ratio, this.NumberOfInputs);
        }
        ...
        {
            return this.Linear.GetDegreesOfFreedom(numberOfSamples);
        }
        ...
        {
            double se = this.GetStandardError(input, informationMatrix);
        ...
        {
            double se = this.GetPredictionStandardError(input, informationMatrix);
            return this.computeInterval(input, numberOfSamples, percent, se);
        }
        ...
        {
            double y = this.linear.Transform(input);
            ...
            DoubleRange nci = new DoubleRange(this.linkFunction.Inverse(lci.Min), this.linkFunction.Inverse(lci.Max));
            return nci;
        }
        ...
        public object Clone()
        {
            return new GeneralizedLinearRegression()
             {
                 Link = (ILinkFunction)this.linkFunction.Clone(),
...
#pragma warning restore 612, 618
        ...
        {
            this.linear.Transform(input, result: result);
            //for (int i = 0; i < input.Length; i++)
        ...
        public override double[] LogLikelihood(double[][] input, double[] result)
        {
            this.linear.Transform(input, result: result);
            for (int i = 0; i < input.Length; i++)
                result[i] = this.linkFunction.Inverse(result[i]);
        ...
        private void SetValuesOnDeserialized(StreamingContext context)
        {
            if (this.linear == null)
            {
                ...
                {
#pragma warning disable 612, 618
                    Weights = this.coefficients.Get(1, 0),
