...
namespace Openize.Accord.Statistics.Models.Regression.Nonlinear
{
    ...
    public class NonlinearRegression : TransformBase<double[], double>, ICloneable
    {
        ...
        {
            return this.function(this.coefficients, inputs);
        }
        ...
        public object Clone()
        {
            var clone = new NonlinearRegression(this.Coefficients.Length, this.function, this.gradient);
        ...
        {
            return this.function(this.coefficients, input);
        }
    }
}
