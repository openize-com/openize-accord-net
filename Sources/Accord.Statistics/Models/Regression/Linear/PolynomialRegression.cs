...
#pragma warning restore 612, 618
    {
        ...
        public int Degree
        {
            get { return this.regression.Weights.Length; }
        }
        ...
        {
#pragma warning disable 612, 618
            get { return this.regression.Weights.Concatenate(this.Intercept); }
#pragma warning restore 612, 618
        }
        ...
        {
            get { return this.regression.Weights; }
            set
            {
                this.regression.Weights = value;
        ...
        {
            get { return this.regression.Intercept; }
            set { this.regression.Intercept = value; }
        }
        ...
        public double Regress(double[] inputs, double[] outputs)
        {
            ...
            this.regression.Weights.SetTo(fit.Weights);
            this.regression.Intercept = fit.Intercept;

            return new SquareLoss(outputs).Loss(this.Transform(inputs));
        }
        ...
        public double CoefficientOfDetermination(double[] inputs, double[] outputs, bool adjust, double[] weights = null)
        {
            ...
            return this.regression.CoefficientOfDetermination(polynomial, outputs, adjust, weights);
        }
        ...
        {
            return this.ToString(null as string);
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            {
                int degree = this.regression.Weights.Length - i;
                double coeff = this.regression.Weights[i];
                ...
                if (i < this.regression.Weights.Length - 1)
                    sb.Append(" + ");
            }

            string interceptStr = format == null ?
                    this.Intercept.ToString(formatProvider) :
                    this.Intercept.ToString(format, formatProvider);
...
#pragma warning restore 612, 618
        ...
        public override double Transform(double input)
        {
            ...
            return this.regression.Transform(polynomial);
        }
        ...
        public override double[] Transform(double[] input, double[] result)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                result[i] = this.regression.Transform(polynomial);
            }
