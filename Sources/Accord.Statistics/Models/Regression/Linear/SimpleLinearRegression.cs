...
#pragma warning disable 612, 618
            this.regression = new MultipleLinearRegression(2, false);
            double err = this.regression.Regress(X, outputs);
            this.slope = this.regression.Coefficients[1];
            this.intercept = this.regression.Coefficients[0];
#pragma warning restore 612, 618
            return err;
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            string a = format != null ?
                this.Slope.ToString(format, formatProvider) :
                this.Slope.ToString(formatProvider);
...
#pragma warning restore 612, 618
        ...
        public double GetStandardError(double[] inputs, double[] outputs)
        {
            ...
            return Math.Sqrt(ss / this.GetDegreesOfFreedom(inputs.Length));
        }
        ...
        {
            double se = this.GetStandardError(inputs, outputs);
        ...
        {
            double se = this.GetStandardError(input, inputs, outputs);
            return this.createInterval(input, inputs, percent, se);
        }
        ...
        {
            double se = this.GetPredictionStandardError(input, inputs, outputs);
            return this.createInterval(input, inputs, percent, se);
        }
        ...
        private DoubleRange createInterval(double input, double[] inputs, double percent, double se)
        {
            ...
            double df = this.GetDegreesOfFreedom(inputs.Length);
