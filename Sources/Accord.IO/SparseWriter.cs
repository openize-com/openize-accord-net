    ...
    public class SparseWriter : IDisposable
    {
        ...
        public void Write(double[][] features, bool[] outputs)
        {
            for (int i = 0; i < features.Length; i++)
                this.Write(features[i], outputs[i]);
        }
        ...
        {
            this.Write(Sparse.FromDense(feature), output);
        }
        ...
        {
            this.Write(Sparse.FromDense(feature), output, comment);
        }
        ...
        public void Write(Sparse<double> feature, double output, string comment)
        {
            this.writer.Write(output);
            this.writer.Write(" ");
            this.writer.Write(feature.ToString());
            this.writer.Write(" # ");
