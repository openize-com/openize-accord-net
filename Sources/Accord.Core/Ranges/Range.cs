...
namespace FileFormat.Accord.Core.Ranges
{
    using System;
    ...
    public struct Range : IRange<float>, IEquatable<Range>
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hash = 17;
                hash = hash * 31 + this.min.GetHashCode();
                hash = hash * 31 + this.max.GetHashCode();
                return hash;
            }
        }
        ...
        public IntRange ToIntRange(bool provideInnerRange)
        {
            ...
            {
                iMin = (int)System.Math.Ceiling(this.min);
                iMax = (int)System.Math.Floor(this.max);
            }
            else
            {
                iMin = (int)System.Math.Floor(this.min);
                iMax = (int)System.Math.Ceiling(this.max);
            }
